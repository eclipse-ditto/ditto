...
/**
 * Unit test for {@link RetrieveWotValidationConfigStrategy}.
 */
public final class RetrieveWotValidationConfigStrategyTest {

    private RetrieveWotValidationConfigStrategy underTest;
    ...
    public void setUp() {
        ...
        underTest = new RetrieveWotValidationConfigStrategy();
    }
    ...
    public void retrieveConfig() {
        ...
        final RetrieveWotValidationConfig command = RetrieveWotValidationConfig.of(configId, headers);
        ...
        assertThat(response.getValidationConfig()).isEqualTo(existingConfig.toJson());
    }
