...
public interface ThingEventConfig extends EventConfig {
    ...
    /**
     * Contains pre-defined (configured) {@code extraFields} to send along all thing (change) events and thing messages.
     *
    ...
    enum ThingEventConfigValue implements KnownConfigValue {
        ...
        /**
         * The pre-defined (configured) {@code extraFields} to send along all events and messages.
         */
