...
public final class ModifyFeatureDesiredProperties extends AbstractCommand<ModifyFeatureDesiredProperties> implements
    ...
    @Override
    public ModifyFeatureDesiredProperties setEntity(final JsonValue entity) {
        return of(thingId, featureId, ThingsModelFactory.newFeatureProperties(entity.asObject()), getDittoHeaders());
    }
