...
public final class ModifyAttributes extends AbstractCommand<ModifyAttributes>
    ...
    @Override
    public ModifyAttributes setEntity(final JsonValue entity) {
        return of(thingId, entity.isNull() ? ThingsModelFactory.nullAttributes() :
                ThingsModelFactory.newAttributes(entity.asObject()),
                getDittoHeaders());
    }
