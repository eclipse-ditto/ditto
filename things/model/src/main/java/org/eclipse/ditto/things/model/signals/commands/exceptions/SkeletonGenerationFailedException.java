...
public final class SkeletonGenerationFailedException extends DittoRuntimeException implements ThingException {
    ...
    private static final String MESSAGE_TEMPLATE = "Failed to generate a valid skeleton for Thing ID: ''{0}''.";
    ...
    public static final class Builder extends DittoRuntimeExceptionBuilder<SkeletonGenerationFailedException> {
        ...
        private Builder(final ThingId thingId) {
            message(MESSAGE_TEMPLATE.replace("''{0}''", thingId.toString()));
