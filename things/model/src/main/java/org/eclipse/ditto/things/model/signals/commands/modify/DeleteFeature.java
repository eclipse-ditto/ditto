...
public final class DeleteFeature extends AbstractCommand<DeleteFeature> implements ThingModifyCommand<DeleteFeature>,
    ...
    private DeleteFeature(final ThingId thingId, final String featureId, final DittoHeaders dittoHeaders) {
    ...
    @Override
    public DeleteFeature setEntity(final JsonValue entity) {
        return this;
    }
