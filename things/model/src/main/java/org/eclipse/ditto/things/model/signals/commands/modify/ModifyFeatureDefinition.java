...
public final class ModifyFeatureDefinition extends AbstractCommand<ModifyFeatureDefinition>
    ...
    @Override
    public ModifyFeatureDefinition setEntity(final JsonValue entity) {
        return of(thingId, featureId, ThingsModelFactory.newFeatureDefinition(entity.asArray()), getDittoHeaders());
    }
