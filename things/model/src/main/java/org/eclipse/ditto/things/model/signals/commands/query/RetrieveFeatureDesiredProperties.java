...
/**
 * This command retrieves a {@link org.eclipse.ditto.things.model.Feature}'s desired properties.
 *
 * @since 1.5.0
 */
@Immutable
@JsonParsableCommand(typePrefix = ThingCommand.TYPE_PREFIX, name = RetrieveFeatureDesiredProperties.NAME)
public final class RetrieveFeatureDesiredProperties extends AbstractCommand<RetrieveFeatureDesiredProperties> implements
    ...
    /**
     * Returns a Command for retrieving a {@link org.eclipse.ditto.things.model.Feature}'s desired properties on a Thing.
     *
    ...
    /**
     * RetrieveFeatureDesiredProperties is only available in JsonSchemaVersion V_2.
     *
