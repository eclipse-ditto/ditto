...
/**
 * Unit test for {@link FeaturePropertiesNotModifiableException}.
 */
public class FeaturePropertiesNotModifiableExceptionTest {

    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            .set(DittoRuntimeException.JsonFields.STATUS, HttpStatus.NOT_FOUND.getCode())
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, FeaturePropertiesNotModifiableException.ERROR_CODE)
    ...
    public void assertImmutability() {
        assertInstancesOf(FeaturePropertiesNotModifiableException.class, areImmutable());
    }
