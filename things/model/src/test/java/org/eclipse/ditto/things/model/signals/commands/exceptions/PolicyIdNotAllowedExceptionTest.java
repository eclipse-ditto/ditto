...
/**
 * Unit test for {@link PolicyIdNotAllowedException}.
 */
public class PolicyIdNotAllowedExceptionTest {

    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            .set(DittoRuntimeException.JsonFields.STATUS, HttpStatus.NOT_FOUND.getCode())
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, PolicyIdNotAllowedException.ERROR_CODE)
            .set(DittoRuntimeException.JsonFields.MESSAGE,
                    TestConstants.Thing.POLICY_ID_NOT_ALLOWED_EXCEPTION.getMessage())
    ...
    public void checkThingErrorCodeWorks() {
        ...
        assertThat(actual).isEqualTo(TestConstants.Thing.POLICY_ID_NOT_ALLOWED_EXCEPTION);
    }
