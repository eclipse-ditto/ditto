...
/**
 * Unit test for {@link AttributesNotAccessibleException}.
 */
public class AttributesNotAccessibleExceptionTest {

    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            .set(DittoRuntimeException.JsonFields.STATUS, HttpStatus.NOT_FOUND.getCode())
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, AttributesNotAccessibleException.ERROR_CODE)
            .set(DittoRuntimeException.JsonFields.MESSAGE,
                    TestConstants.Thing.ATTRIBUTES_NOT_ACCESSIBLE_EXCEPTION.getMessage())
    ...
    public void checkAttributesErrorCodeWorks() {
        ...
        assertThat(actual).isEqualTo(TestConstants.Thing.ATTRIBUTES_NOT_ACCESSIBLE_EXCEPTION);
    }
