...
/**
 * Unit test for {@link DeleteFeaturePropertiesResponse}.
 */
public final class DeleteFeaturePropertiesResponseTest {
    ...
    public void assertImmutability() {
        assertInstancesOf(DeleteFeaturePropertiesResponse.class, areImmutable(),
    ...
    public void testHashCodeAndEquals() {
        EqualsVerifier.forClass(DeleteFeaturePropertiesResponse.class)
    ...
    public void createInstanceFromValidJson() {
        final DeleteFeaturePropertiesResponse underTest =
                DeleteFeaturePropertiesResponse.fromJson(KNOWN_JSON, TestConstants.EMPTY_DITTO_HEADERS);
