...
/**
 * Unit test for {@link ThingIdNotExplicitlySettableException}.
 */
public class ThingIdNotExplicitlySettableExceptionTest {

    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            .set(DittoRuntimeException.JsonFields.STATUS, HttpStatus.NOT_FOUND.getCode())
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, ThingIdNotExplicitlySettableException.ERROR_CODE)
            .set(DittoRuntimeException.JsonFields.MESSAGE,
                    TestConstants.Thing.THING_ID_NOT_EXPLICITLY_SETTABLE_EXCEPTION.getMessage())
    ...
    public void checkThingErrorCodeWorks() {
        ...
        assertThat(actual).isEqualTo(TestConstants.Thing.THING_ID_NOT_EXPLICITLY_SETTABLE_EXCEPTION);
    }
