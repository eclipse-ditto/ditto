...
/**
 * Unit test for {@link FeaturePropertiesNotAccessibleException}.
 */
public class FeaturePropertiesNotAccessibleExceptionTest {

    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            .set(DittoRuntimeException.JsonFields.STATUS, HttpStatus.NOT_FOUND.getCode())
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, FeaturePropertiesNotAccessibleException.ERROR_CODE)
