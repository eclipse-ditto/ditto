...
/**
 * This strategy handles {@link ImportsAliasSubjectsModified} events.
 */
final class ImportsAliasSubjectsModifiedStrategy
        extends AbstractPolicyEventStrategy<ImportsAliasSubjectsModified> {

    @Override
    protected PolicyBuilder applyEvent(final ImportsAliasSubjectsModified event, final Policy policy,
