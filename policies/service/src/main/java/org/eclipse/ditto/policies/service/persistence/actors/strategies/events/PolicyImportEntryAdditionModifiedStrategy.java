...
/**
 * This strategy handles {@link PolicyImportEntryAdditionModified} events.
 */
final class PolicyImportEntryAdditionModifiedStrategy
        extends AbstractPolicyEventStrategy<PolicyImportEntryAdditionModified> {

    @Override
    protected PolicyBuilder applyEvent(final PolicyImportEntryAdditionModified event, final Policy policy,
