...
/**
 * This strategy handles {@link ImportsAliasSubjectCreated} events.
 */
final class ImportsAliasSubjectCreatedStrategy
        extends AbstractPolicyEventStrategy<ImportsAliasSubjectCreated> {

    @Override
    protected PolicyBuilder applyEvent(final ImportsAliasSubjectCreated event, final Policy policy,
