...
/**
 * This strategy handles {@link SubjectAliasSubjectModified} events.
 */
final class SubjectAliasSubjectModifiedStrategy
        extends AbstractPolicyEventStrategy<SubjectAliasSubjectModified> {

    @Override
    protected PolicyBuilder applyEvent(final SubjectAliasSubjectModified event, final Policy policy,
