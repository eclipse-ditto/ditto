...
/**
 * This strategy handles the {@link RetrievePolicyEntryAllowedImportAdditions} command.
 */
final class RetrievePolicyEntryAllowedImportAdditionsStrategy
        extends AbstractPolicyQueryCommandStrategy<RetrievePolicyEntryAllowedImportAdditions> {

    RetrievePolicyEntryAllowedImportAdditionsStrategy(final PolicyConfig policyConfig) {
        super(RetrievePolicyEntryAllowedImportAdditions.class, policyConfig);
    }
    ...
    @Override
    public Optional<EntityTag> nextEntityTag(final RetrievePolicyEntryAllowedImportAdditions command,
