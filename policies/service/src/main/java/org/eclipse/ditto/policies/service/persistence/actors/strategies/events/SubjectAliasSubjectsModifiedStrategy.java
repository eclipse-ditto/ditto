...
/**
 * This strategy handles {@link SubjectAliasSubjectsModified} events.
 */
final class SubjectAliasSubjectsModifiedStrategy
        extends AbstractPolicyEventStrategy<SubjectAliasSubjectsModified> {

    @Override
    protected PolicyBuilder applyEvent(final SubjectAliasSubjectsModified event, final Policy policy,
