...
/**
 * This strategy handles the {@link RetrievePolicyEntryNamespaces} command.
 */
final class RetrievePolicyEntryNamespacesStrategy
        extends AbstractPolicyQueryCommandStrategy<RetrievePolicyEntryNamespaces> {

    RetrievePolicyEntryNamespacesStrategy(final PolicyConfig policyConfig) {
        super(RetrievePolicyEntryNamespaces.class, policyConfig);
    }
    ...
    @Override
    public Optional<EntityTag> nextEntityTag(final RetrievePolicyEntryNamespaces command,
