...
/**
 * This strategy handles {@link SubjectAliasSubjectCreated} events.
 */
final class SubjectAliasSubjectCreatedStrategy
        extends AbstractPolicyEventStrategy<SubjectAliasSubjectCreated> {

    @Override
    protected PolicyBuilder applyEvent(final SubjectAliasSubjectCreated event, final Policy policy,
