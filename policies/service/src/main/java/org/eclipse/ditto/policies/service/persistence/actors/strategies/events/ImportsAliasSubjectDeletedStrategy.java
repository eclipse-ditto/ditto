...
/**
 * This strategy handles {@link ImportsAliasSubjectDeleted} events.
 */
final class ImportsAliasSubjectDeletedStrategy
        extends AbstractPolicyEventStrategy<ImportsAliasSubjectDeleted> {

    @Override
    protected PolicyBuilder applyEvent(final ImportsAliasSubjectDeleted event, final Policy policy,
