...
public class ModifyPolicySubstitutionStrategyTest extends AbstractPolicySubstitutionStrategyTestBase {
    ...
    public void applyReturnsTheSameCommandInstanceWhenNoPlaceholderIsSpecified() {
        ...
        final ModifyPolicy commandWithoutPlaceholders = ModifyPolicy.of(AbstractPolicySubstitutionStrategyTestBase.POLICY_ID, policy, AbstractPolicySubstitutionStrategyTestBase.DITTO_HEADERS);
    ...
    public void applyReturnsTheReplacedCommandInstanceWhenPlaceholderIsSpecified() {
        final PolicyEntry policyEntryWithPlaceholders = PolicyEntry.newInstance(
                ...
                Subjects.newInstance(Subject.newInstance(AbstractPolicySubstitutionStrategyTestBase.SUBJECT_ID_PLACEHOLDER, SubjectType.GENERATED)),
                AbstractPolicySubstitutionStrategyTestBase.RESOURCES);
        ...
        final ModifyPolicy commandWithPlaceholders = ModifyPolicy.of(AbstractPolicySubstitutionStrategyTestBase.POLICY_ID, policyWithPlaceholders, AbstractPolicySubstitutionStrategyTestBase.DITTO_HEADERS);
        ...
        final PolicyEntry expectedPolicyEntryReplaced = PolicyEntry.newInstance(
                AbstractPolicySubstitutionStrategyTestBase.LABEL,
                Subjects.newInstance(Subject.newInstance(AbstractPolicySubstitutionStrategyTestBase.SUBJECT_ID, SubjectType.GENERATED)),
                AbstractPolicySubstitutionStrategyTestBase.RESOURCES);
        ...
        final ModifyPolicy expectedCommandReplaced =
                ModifyPolicy.of(AbstractPolicySubstitutionStrategyTestBase.POLICY_ID, expectedPolicyReplaced, AbstractPolicySubstitutionStrategyTestBase.DITTO_HEADERS);
