...
/**
 * Thrown if the {@link org.eclipse.ditto.policies.model.Subjects} of a {@link org.eclipse.ditto.policies.model.PolicyEntry}
 * could not be modified because the requester had insufficient permissions.
 */
@Immutable
@JsonParsableException(errorCode = SubjectsNotModifiableException.ERROR_CODE)
public final class SubjectsNotModifiableException extends DittoRuntimeException implements PolicyException {
    ...
    /**
     * A mutable builder with a fluent API for a {@link org.eclipse.ditto.policies.model.signals.commands.exceptions.SubjectsNotModifiableException}.
     */
    @NotThreadSafe
