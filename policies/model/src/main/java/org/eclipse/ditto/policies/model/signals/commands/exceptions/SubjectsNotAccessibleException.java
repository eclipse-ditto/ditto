...
/**
 * Thrown if {@link org.eclipse.ditto.policies.model.Subjects} could not be loaded due to missing authorization.
 */
@Immutable
@JsonParsableException(errorCode = SubjectsNotAccessibleException.ERROR_CODE)
public class SubjectsNotAccessibleException extends DittoRuntimeException implements PolicyException {
    ...
    /**
     * A mutable builder with a fluent API for a {@link org.eclipse.ditto.policies.model.signals.commands.exceptions.SubjectsNotAccessibleException}.
     */
    @NotThreadSafe
