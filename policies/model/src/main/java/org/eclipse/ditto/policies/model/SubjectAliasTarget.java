...
/**
 * A target reference within a {@link SubjectAlias}, pointing to a specific entry addition in a policy import.
 * Consists of the imported policy ID and the entry label within that import's entries additions.
 *
 * @since 3.9.0
 */
public interface SubjectAliasTarget extends Jsonifiable.WithFieldSelectorAndPredicate<JsonField> {
    ...
    /**
     * SubjectAliasTarget is only available in JsonSchemaVersion V_2.
     *
    ...
    /**
     * Returns all non-hidden marked fields of this SubjectAliasTarget.
     *
    ...
    /**
     * Known JSON fields of a SubjectAliasTarget.
     */
