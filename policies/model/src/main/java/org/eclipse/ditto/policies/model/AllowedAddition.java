...
public enum AllowedAddition {
    ...
    AllowedAddition(final String name) {
        this.name = name;
    }
    ...
    /**
     * Returns the {@code AllowedAddition} matching the given name.
     *
     * @param name the name to look up.
     * @return the matching {@code AllowedAddition}, or empty if no match.
     * @throws NullPointerException if {@code name} is {@code null}.
     */
    public static Optional<AllowedAddition> forName(final CharSequence name) {
