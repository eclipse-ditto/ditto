...
/**
 * Thrown if a {@link org.eclipse.ditto.policies.model.Subject} was either not present or the requester had insufficient
...
public final class SubjectNotAccessibleException extends DittoRuntimeException implements PolicyException {
     ...
     */
    public static SubjectNotAccessibleException fromMessage(@Nullable final String message,
    ...
    /**
     * A mutable builder with a fluent API for a {@link org.eclipse.ditto.policies.model.signals.commands.exceptions.SubjectNotAccessibleException}.
     */
    @NotThreadSafe
