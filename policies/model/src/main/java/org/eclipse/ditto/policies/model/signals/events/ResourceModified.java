...
/**
 * This event is emitted after a {@link org.eclipse.ditto.policies.model.Resource} was modified.
 */
@Immutable
@JsonParsableEvent(name = ResourceModified.NAME, typePrefix = PolicyEvent.TYPE_PREFIX)
public final class ResourceModified extends AbstractPolicyEvent<ResourceModified>
     ...
     * @param resource the modified {@link org.eclipse.ditto.policies.model.Resource}
    ...
    public static ResourceModified of(final PolicyId policyId,
        ...
        return new ResourceModified(policyId, label, resource, revision, timestamp, dittoHeaders, metadata);
    }
    ...
    public static ResourceModified fromJson(final JsonObject jsonObject, final DittoHeaders dittoHeaders) {
        return new EventJsonDeserializer<ResourceModified>(TYPE, jsonObject).deserialize(
            ...
            return of(policyId, label, extractedModifiedResource, revision, timestamp, dittoHeaders, metadata);
        });
    }
    ...
    /**
     * Returns the modified {@link org.eclipse.ditto.policies.model.Resource}.
     *
     * @return the modified {@link org.eclipse.ditto.policies.model.Resource}.
     */
    ...
    @Override
    public ResourceModified setEntity(final JsonValue entity) {
        return of(getPolicyEntityId(), label, PoliciesModelFactory.newResource(resource.getResourceKey(), entity),
