...
/**
 * A subject alias maps a {@link Label} to one or more {@link SubjectAliasTarget}s. Subject operations on the alias
 * label transparently fan out to all referenced entries additions targets.
 *
 * @since 3.9.0
 */
public interface SubjectAlias extends Jsonifiable.WithFieldSelectorAndPredicate<JsonField> {
    ...
    /**
     * Returns the list of {@link SubjectAliasTarget}s this alias fans out to.
     *
     * @return the unmodifiable list of targets.
     */
    List<SubjectAliasTarget> getTargets();

    /**
     * SubjectAlias is only available in JsonSchemaVersion V_2.
     *
    ...
    /**
     * Returns all non-hidden marked fields of this SubjectAlias.
     *
    ...
    /**
     * Known JSON fields of a SubjectAlias.
     */
