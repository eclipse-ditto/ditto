...
/**
 * This event is emitted after an {@link org.eclipse.ditto.policies.model.EntryAddition} was modified in a
 * {@link org.eclipse.ditto.policies.model.PolicyImport}.
 *
 * @since 3.9.0
 */
@Immutable
@JsonParsableEvent(name = PolicyImportEntryAdditionModified.NAME, typePrefix = PolicyEvent.TYPE_PREFIX)
public final class PolicyImportEntryAdditionModified extends AbstractPolicyEvent<PolicyImportEntryAdditionModified>
        implements PolicyEvent<PolicyImportEntryAdditionModified> {

    /**
     * Name of this event.
     */
    public static final String NAME = "policyImportEntryAdditionModified";
    ...
    private PolicyImportEntryAdditionModified(final PolicyId policyId,
    ...
    /**
     * Constructs a new {@code PolicyImportEntryAdditionModified} object.
     *
     * @param policyId the identifier of the Policy to which the modified entry addition belongs.
     * @param importedPolicyId the ID of the imported Policy.
     * @param entryAddition the modified {@link org.eclipse.ditto.policies.model.EntryAddition}.
     * @param revision the revision of the Policy.
     * @param timestamp the timestamp of this event.
     * @param dittoHeaders the headers of the command which was the cause of this event.
     * @param metadata the metadata to apply for the event.
     * @return the created PolicyImportEntryAdditionModified.
     * @throws NullPointerException if any argument but {@code timestamp} and {@code metadata} is {@code null}.
     */
    public static PolicyImportEntryAdditionModified of(final PolicyId policyId,
            final PolicyId importedPolicyId,
            final EntryAddition entryAddition,
            final long revision,
            @Nullable final Instant timestamp,
        ...
        return new PolicyImportEntryAdditionModified(policyId, importedPolicyId, entryAddition, revision, timestamp,
                dittoHeaders, metadata);
    }

    /**
     * Creates a new {@code PolicyImportEntryAdditionModified} from a JSON string.
     *
     * @param jsonString the JSON string from which a new PolicyImportEntryAdditionModified instance is to be created.
     * @param dittoHeaders the headers of the command which was the cause of this event.
     * @return the {@code PolicyImportEntryAdditionModified} which was created from the given JSON string.
     * @throws NullPointerException if {@code jsonString} is {@code null}.
     * @throws org.eclipse.ditto.json.JsonParseException if the passed in {@code jsonString} was not in the expected
     * 'PolicyImportEntryAdditionModified' format.
     */
    public static PolicyImportEntryAdditionModified fromJson(final String jsonString,
            final DittoHeaders dittoHeaders) {
    ...
    /**
     * Creates a new {@code PolicyImportEntryAdditionModified} from a JSON object.
     *
     * @param jsonObject the JSON object from which a new PolicyImportEntryAdditionModified instance is to be created.
     * @param dittoHeaders the headers of the command which was the cause of this event.
     * @return the {@code PolicyImportEntryAdditionModified} which was created from the given JSON object.
     * @throws NullPointerException if {@code jsonObject} is {@code null}.
     * @throws org.eclipse.ditto.json.JsonParseException if the passed in {@code jsonObject} was not in the expected
     * 'PolicyImportEntryAdditionModified' format.
     */
    public static PolicyImportEntryAdditionModified fromJson(final JsonObject jsonObject,
            final DittoHeaders dittoHeaders) {

        return new EventJsonDeserializer<PolicyImportEntryAdditionModified>(TYPE, jsonObject).deserialize(
    ...
    /**
     * Returns the modified {@link org.eclipse.ditto.policies.model.EntryAddition}.
     *
     * @return the modified EntryAddition.
     */
    ...
    @Override
    public PolicyImportEntryAdditionModified setEntity(final JsonValue entity) {
    ...
    @Override
    public PolicyImportEntryAdditionModified setRevision(final long revision) {
    ...
    @Override
    public PolicyImportEntryAdditionModified setDittoHeaders(final DittoHeaders dittoHeaders) {
    ...
    public boolean equals(@Nullable final Object o) {
        ...
        final PolicyImportEntryAdditionModified that = (PolicyImportEntryAdditionModified) o;
    ...
    protected boolean canEqual(@Nullable final Object other) {
        return other instanceof PolicyImportEntryAdditionModified;
    }
