...
/**
 * Thrown if a {@link org.eclipse.ditto.policies.model.Policy} could not be modified as the resulting {@link
 * org.eclipse.ditto.policies.model.Policy} would be invalid. The cause of this exception is documented in the message.
 */
@Immutable
@JsonParsableException(errorCode = PolicyModificationInvalidException.ERROR_CODE)
public final class PolicyModificationInvalidException extends DittoRuntimeException implements PolicyException {
    ...
    /**
     * A mutable builder with a fluent API for a {@link org.eclipse.ditto.policies.model.signals.commands.exceptions.PolicyModificationInvalidException}.
     */
    @NotThreadSafe
