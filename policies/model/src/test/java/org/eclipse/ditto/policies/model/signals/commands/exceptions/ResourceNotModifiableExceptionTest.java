...
/**
 * Unit test for {@link org.eclipse.ditto.policies.model.signals.commands.exceptions.ResourceNotModifiableException}.
 */
public class ResourceNotModifiableExceptionTest {
    ...
    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            ...
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, ResourceNotModifiableException.ERROR_CODE)
            .set(DittoRuntimeException.JsonFields.MESSAGE,
                    TestConstants.Policy.RESOURCE_NOT_MODIFIABLE_EXCEPTION.getMessage())
    ...
    public void assertImmutability() {
        assertInstancesOf(ResourceNotModifiableException.class, areImmutable());
    }


    @Test
    public void checkResourceErrorCodeWorks() {
        final DittoRuntimeException actual =
                GlobalErrorRegistry.getInstance().parse(KNOWN_JSON, TestConstants.EMPTY_DITTO_HEADERS);

        assertThat(actual).isEqualTo(TestConstants.Policy.RESOURCE_NOT_MODIFIABLE_EXCEPTION);
    }
