...
public class Scenario3Revoke10 implements Scenario3Revoke {

    private final ScenarioSetup setup;

    public Scenario3Revoke10() {
        setup = Scenario.newScenarioSetup( //
                false, //
                "Subject has READ granted on '/features'. Subject has READ revoked on '/features/firmware'. Is NOT able to WRITE '/features'",
                //
                getPolicy(), //
