...
public class Scenario4MultipleSubjects16 implements Scenario4MultipleSubjects {

    private final ScenarioSetup setup;

    public Scenario4MultipleSubjects16() {
        setup = Scenario.newScenarioSetup( //
                ...
                "Subject_5 has READ granted on '/features/public/properties/location'. "
                        ...
                        +
                        "Is NOT able to READ '/features/lamp/properties/config' with hasPermissionsOnResourceOrAnySubresource()",
                //
                getPolicy(), //
