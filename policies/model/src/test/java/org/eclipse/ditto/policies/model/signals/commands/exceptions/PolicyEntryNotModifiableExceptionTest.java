...
public final class PolicyEntryNotModifiableExceptionTest {
    ...
    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            ...
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, PolicyEntryNotModifiableException.ERROR_CODE)
            .set(DittoRuntimeException.JsonFields.MESSAGE,
                    TestConstants.Policy.POLICY_ENTRY_NOT_MODIFIABLE_EXCEPTION.getMessage())
    ...
    public void checkPolicyEntryErrorCodeWorks() {
        ...
        assertThat(actual).isEqualTo(TestConstants.Policy.POLICY_ENTRY_NOT_MODIFIABLE_EXCEPTION);
    }
