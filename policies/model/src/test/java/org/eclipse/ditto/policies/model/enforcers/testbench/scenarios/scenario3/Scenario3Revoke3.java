...
public class Scenario3Revoke3 implements Scenario3Revoke {

    private final ScenarioSetup setup;

    public Scenario3Revoke3() {
        setup = Scenario.newScenarioSetup( //
                false, //
                "Subject has READ+WRITE granted on '/'. Subject has READ+WRITE revoked on '/attributes'. Subject has READ granted on '/attributes/location'. Is NOT able to WRITE '/'",
                //
                getPolicy(), //
