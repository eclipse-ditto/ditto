...
/**
 * Unit test for {@link PolicyImportEntryAdditionDeleted}.
 */
public final class PolicyImportEntryAdditionDeletedTest {

    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            .set(Event.JsonFields.TIMESTAMP, TestConstants.TIMESTAMP.toString())
            .set(Event.JsonFields.TYPE, PolicyImportEntryAdditionDeleted.TYPE)
            ...
            .set(PolicyImportEntryAdditionDeleted.JSON_IMPORTED_POLICY_ID,
                    TestConstants.Policy.IMPORTED_POLICY_ID.toString())
            .set(PolicyImportEntryAdditionDeleted.JSON_LABEL, TestConstants.Policy.LABEL.toString())
            .build();

    @Test
    public void testHashCodeAndEquals() {
        EqualsVerifier.forClass(PolicyImportEntryAdditionDeleted.class)
    ...
    public void tryToCreateInstanceWithNullPolicyId() {
        PolicyImportEntryAdditionDeleted.of(null, TestConstants.Policy.IMPORTED_POLICY_ID,
    ...
    public void tryToCreateInstanceWithNullImportedPolicyId() {
        PolicyImportEntryAdditionDeleted.of(TestConstants.Policy.POLICY_ID, null,
                TestConstants.Policy.LABEL, TestConstants.Policy.REVISION_NUMBER,
                TestConstants.TIMESTAMP, TestConstants.EMPTY_DITTO_HEADERS, TestConstants.METADATA);
    }
    ...
    public void tryToCreateInstanceWithNullLabel() {
        PolicyImportEntryAdditionDeleted.of(TestConstants.Policy.POLICY_ID,
    ...
    public void toJsonReturnsExpected() {
        final PolicyImportEntryAdditionDeleted underTest = PolicyImportEntryAdditionDeleted.of(
    ...
    public void createInstanceFromValidJson() {
        final PolicyImportEntryAdditionDeleted underTest =
                PolicyImportEntryAdditionDeleted.fromJson(KNOWN_JSON.toString(),
