...
public class Scenario4MultipleSubjects9 implements Scenario4MultipleSubjects {

    private final ScenarioSetup setup;

    public Scenario4MultipleSubjects9() {
        setup = Scenario.newScenarioSetup( //
                ...
                "Subject_1 has READ+WRITE granted on '/'. " + "Subject_3 has WRITE revoked on '/'. "
                        ...
                        + "Is NOT able to WRITE '/attributes/nogo2' with hasPermissionsOnResourceOrAnySubresource()", //
                getPolicy(), //
