...
public class PolicyEntryModificationInvalidExceptionTest {
    ...
    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            ...
            .set(DittoRuntimeException.JsonFields.ERROR_CODE, PolicyEntryModificationInvalidException.ERROR_CODE)
            .set(DittoRuntimeException.JsonFields.MESSAGE,
                    TestConstants.Policy.POLICY_ENTRY_MODIFICATION_INVALID_EXCEPTION.getMessage())
