...
/**
 * Unit test for {@link PolicyImportEntryAdditionModified}.
 */
public final class PolicyImportEntryAdditionModifiedTest {

    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            .set(Event.JsonFields.TIMESTAMP, TestConstants.TIMESTAMP.toString())
            .set(Event.JsonFields.TYPE, PolicyImportEntryAdditionModified.TYPE)
            ...
            .set(PolicyImportEntryAdditionModified.JSON_IMPORTED_POLICY_ID,
                    TestConstants.Policy.IMPORTED_POLICY_ID.toString())
            .set(PolicyImportEntryAdditionModified.JSON_LABEL, TestConstants.Policy.LABEL.toString())
            .set(PolicyImportEntryAdditionModified.JSON_ENTRY_ADDITION,
                    TestConstants.Policy.ENTRY_ADDITION.toJson(FieldType.regularOrSpecial()))
            .build();

    @Test
    public void testHashCodeAndEquals() {
        EqualsVerifier.forClass(PolicyImportEntryAdditionModified.class)
    ...
    public void tryToCreateInstanceWithNullPolicyId() {
        PolicyImportEntryAdditionModified.of(null, TestConstants.Policy.IMPORTED_POLICY_ID,
    ...
    public void tryToCreateInstanceWithNullImportedPolicyId() {
        PolicyImportEntryAdditionModified.of(TestConstants.Policy.POLICY_ID, null,
                TestConstants.Policy.ENTRY_ADDITION, TestConstants.Policy.REVISION_NUMBER,
                TestConstants.TIMESTAMP, TestConstants.EMPTY_DITTO_HEADERS, TestConstants.METADATA);
    }
    ...
    public void tryToCreateInstanceWithNullEntryAddition() {
        PolicyImportEntryAdditionModified.of(TestConstants.Policy.POLICY_ID,
    ...
    public void toJsonReturnsExpected() {
        final PolicyImportEntryAdditionModified underTest = PolicyImportEntryAdditionModified.of(
    ...
    public void createInstanceFromValidJson() {
        final PolicyImportEntryAdditionModified underTest =
                PolicyImportEntryAdditionModified.fromJson(KNOWN_JSON.toString(),
