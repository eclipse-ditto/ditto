...
public class Scenario4MultipleSubjects23 implements Scenario4MultipleSubjects {

    private final ScenarioSetup setup;

    public Scenario4MultipleSubjects23() {
        setup = Scenario.newScenarioSetup( //
                ...
                "SUBJECT_8 has READ granted on '/attributes'. " //
                        ...
                        + "Is able to READ '/attributes/nogo2' with hasPermissionsOnResourceOrAnySubresource()", //
                getPolicy(), //
