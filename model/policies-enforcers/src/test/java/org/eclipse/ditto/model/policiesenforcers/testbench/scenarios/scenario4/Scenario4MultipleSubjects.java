...
public interface Scenario4MultipleSubjects extends Scenario {
    ...
    Policy POLICY = PoliciesModelFactory //
            ...
            .forLabel("one") //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_1, SubjectType.JWT) //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_2, SubjectType.JWT) //
            .setGrantedPermissions(PoliciesResourceType.thingResource("/"), "READ", "WRITE") //
            .setRevokedPermissions(PoliciesResourceType.thingResource("/attributes"), "READ",
                    "WRITE") //
            .forLabel("two") //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_3, SubjectType.JWT) //
            ...
            .forLabel("four") //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_3, SubjectType.JWT) //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_4, SubjectType.JWT) //
            ...
            .forLabel("five") //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_5, SubjectType.JWT) //
            ...
            .forLabel("six_read") //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_5, SubjectType.JWT) //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_6, SubjectType.JWT) //
            ...
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_7, SubjectType.JWT) //
            .setGrantedPermissions(PoliciesResourceType.thingResource("/attributes"), "WRITE") //
            .forLabel("eight") //
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_8, SubjectType.JWT) //
            .setGrantedPermissions(PoliciesResourceType.thingResource("/attributes"), "READ",
                    "WRITE") //
            .forLabel("nine_write_only")
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_9, SubjectType.JWT)
