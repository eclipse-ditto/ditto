...
public interface JsonViewScenario extends Scenario {
    ...
    Policy POLICY = PoliciesModelFactory //
            ...
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_SOME_GRANTED, SubjectType.JWT) //
            ...
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_SOME_REVOKED, SubjectType.JWT) //
            ...
            .setSubject(SubjectIssuer.GOOGLE_URL, SUBJECT_NONEXISTENT_ATTRIBUTE_GRANTED, SubjectType.JWT)
