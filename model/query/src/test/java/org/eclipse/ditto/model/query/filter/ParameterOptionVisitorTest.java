...
public final class ParameterOptionVisitorTest {
    ...
    public void visitSortOptionOwner() {
        ...
        verify(qbMock).sort(
                Collections.singletonList(new org.eclipse.ditto.model.query.model.query.SortOption(exprMock,
                        SortDirection.ASC)));
    }
    ...
    public void visitSortOptionThingId() {
        ...
        verify(qbMock).sort(
                Collections.singletonList(
                        new org.eclipse.ditto.model.query.model.query.SortOption(exprMock, SortDirection
                                .ASC)));
    }
    ...
    public void visitSortOptionMultiple() {
        ...
        verify(exprFactoryMock).sortBy(FieldExpressionUtil.FIELD_NAME_OWNER);
        verify(qbMock).sort(
                Arrays.asList(new org.eclipse.ditto.model.query.model.query.SortOption(exprMock,
                                SortDirection.DESC),
                        new org.eclipse.ditto.model.query.model.query.SortOption(exprMock,
                                SortDirection.ASC)));
    }
