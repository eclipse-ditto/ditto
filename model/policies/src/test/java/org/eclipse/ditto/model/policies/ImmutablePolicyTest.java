...
public final class ImmutablePolicyTest {
    ...
    private static final SubjectType END_USER_SUBJECT_TYPE_2 = SubjectType.JWT;
    ...
    private static PolicyEntry createPolicyEntry2() {
        return ImmutablePolicyEntry.of(SUPPORT_LABEL,
                Subjects.newInstance(Subject.newInstance(SubjectIssuer.GOOGLE_URL, "someGroup", SubjectType.JWT)),
    ...
    public void setSubjectsForWorks() {
        ...
        final Subject NEW_SUBJECT_1 =
                Subject.newInstance(SubjectIssuer.GOOGLE_URL, "newSubject1", SubjectType.JWT);
        final Subject NEW_SUBJECT_2 =
                Subject.newInstance(SubjectIssuer.GOOGLE_URL, "newSubject2", SubjectType.JWT);
