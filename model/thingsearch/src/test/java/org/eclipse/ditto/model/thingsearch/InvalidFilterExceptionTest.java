...
public class InvalidFilterExceptionTest {
    ...
    private static final InvalidFilterException INVALID_FILTER_EXCEPTION =
    ...
    public void createInstanceFromValidJson() {
        final InvalidFilterException underTest = InvalidFilterException.fromJson(KNOWN_JSON, DittoHeaders.empty());
