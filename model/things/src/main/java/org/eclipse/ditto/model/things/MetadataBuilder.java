...
public interface MetadataBuilder extends JsonObjectBuilder {
    ...
    @Override
    <T> MetadataBuilder set(JsonFieldDefinition<T> fieldDefinition, @Nullable T value,
    ...
    /**
     * Creates a new {@link Metadata} object containing all values which were set to this builder beforehand.
     *
