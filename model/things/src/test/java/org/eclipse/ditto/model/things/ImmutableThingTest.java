...
public final class ImmutableThingTest {
    ...
    private static final Thing KNOWN_THING_V1 =
            ImmutableThing.of(THING_ID, ACL, ATTRIBUTES, FEATURES, LIFECYCLE, REVISION, MODIFIED, METADATA);
    ...
    public void createThingWithoutId() {
        final Thing thing = ImmutableThing.of((ThingId) null, ACL, ATTRIBUTES, FEATURES, LIFECYCLE, REVISION, MODIFIED, METADATA);
    ...
    public void createThingWithoutAttributes() {
        final Thing thing = ImmutableThing.of(THING_ID, ACL, null, FEATURES, LIFECYCLE, REVISION, MODIFIED, METADATA);
    ...
    public void createThingWithoutFeatures() {
        final Thing thing = ImmutableThing.of(THING_ID, ACL, ATTRIBUTES, null, LIFECYCLE, REVISION, MODIFIED, METADATA);
    ...
    public void createThingWithoutLifecycle() {
        final Thing thing = ImmutableThing.of(THING_ID, ACL, ATTRIBUTES, FEATURES, null, REVISION, MODIFIED, METADATA);
    ...
    public void createThingWithoutRevision() {
        final Thing thing = ImmutableThing.of(THING_ID, ACL, ATTRIBUTES, FEATURES, LIFECYCLE, null, MODIFIED, METADATA);
    ...
    public void createThingWithoutModified() {
        final Thing thing = ImmutableThing.of(THING_ID, ACL, ATTRIBUTES, FEATURES, LIFECYCLE, REVISION, null, METADATA);
    ...
    public void setSameAclEntryAgain() {
        final Thing withAcl = ImmutableThing.of(THING_ID, ACL, ATTRIBUTES, FEATURES, LIFECYCLE, REVISION, MODIFIED, METADATA);
    ...
    public void setAttributeToThingWithoutAttributes() {
        ...
        final Thing withoutAttributes = ImmutableThing.of(THING_ID, ACL, null, FEATURES, LIFECYCLE, REVISION, MODIFIED, METADATA);
    ...
    public void setFeaturesToThingWithoutFeatures() {
        final Thing withoutFeatures = ImmutableThing.of(THING_ID, ACL, ATTRIBUTES, null, LIFECYCLE, REVISION, MODIFIED, METADATA);
