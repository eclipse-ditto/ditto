...
final class FallbackNamespacedEntityId extends AbstractNamespacedEntityId {
     ...
     * @throws java.lang.NullPointerException if {@code entityType} is null.
     * @throws NamespacedEntityIdInvalidException if {@code entityId} is {@code null}.
     * @throws NamespacedEntityIdInvalidException if {@code entityId} is empty.
     */
