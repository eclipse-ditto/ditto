 ...
 * {@link RegexPatterns#NO_CONTROL_CHARS_NO_SLASHES_PATTERN} in order to validate that they do not contain control
 * characters as defined in {@link RegexPatterns#CONTROL_CHARS} and no slashes.
 *
 * @since 1.2.0
 */
@Immutable
