 ...
 * {@link JsonParsableCommand#method()} with {@link org.eclipse.ditto.json.JsonObject} as first
...
public @interface JsonParsableCommand {
     ...
     * The Method must return an instance of the command annotated with this annotation.
     *
