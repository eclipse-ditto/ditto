...
/**
 * Unit test for {@link org.eclipse.ditto.services.gateway.endpoints.routes.whoami.WhoamiResponse}.
 */
public final class WhoamiResponseTest {
    ...
    public void createInstanceFromValidJson() {
        ...
        Assertions.assertThat(response.getDittoHeaders()).isEqualTo(DITTO_HEADERS);
        assertThat(response.getEntity()).isEqualTo(USER_INFORMATION.toJson());
    }
