...
public abstract class AbstractRoute extends AllDirectives {
     ...
     * {@link org.eclipse.ditto.services.gateway.endpoints.directives.ContentTypeValidationDirective#ensureValidContentType}, where the supported media-types are
    ...
    /**
     * Provides a composed directive of {@link AllDirectives#extractDataBytes} and
     * {@link org.eclipse.ditto.services.gateway.endpoints.directives.ContentTypeValidationDirective#ensureValidContentType}, where the only supported media-type is
