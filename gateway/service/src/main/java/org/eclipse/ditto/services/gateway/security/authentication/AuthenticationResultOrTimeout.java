...
/**
 * Waits for the future holding an {@link org.eclipse.ditto.services.gateway.security.authentication.AuthenticationResult} and returns a failed authentication result with
 * {@link GatewayAuthenticationProviderUnavailableException} as reason if this takes longer than defined in
 * {@link org.eclipse.ditto.services.gateway.security.authentication.AuthenticationResultOrTimeout#AWAIT_AUTH_TIMEOUT}.
 * <p>
 */
@ThreadSafe
public final class AuthenticationResultOrTimeout<R extends AuthenticationResult>
     ...
     * {@link org.eclipse.ditto.services.gateway.security.authentication.AuthenticationResultOrTimeout#awaitAuthTimeout}.
     */
    @Override
