...
/**
 * Handles authentication by using a defined header field {@link org.eclipse.ditto.services.gateway.security.HttpHeader#X_DITTO_PRE_AUTH} which proxies in front
 ...
 * {@link org.eclipse.ditto.services.gateway.security.HttpHeader#X_DITTO_PRE_AUTH}, otherwise anyone using the HTTP API may impersonate any other authorization
 * subject.
 *
 * @since 1.1.0
 */
