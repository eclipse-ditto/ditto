...
/**
 * Default implementation for {@link GenericMqttClientFactory}.
 */
@Immutable
final class DefaultGenericMqttClientFactory implements GenericMqttClientFactory {

    private DefaultGenericMqttClientFactory() {
        super();
    }

    /**
     * Returns a new instance of {@code DefaultGenericMqttClientFactory}.
     *
     * @return the instance.
     */
    static DefaultGenericMqttClientFactory newInstance() {
        return new DefaultGenericMqttClientFactory();
    }

    @Override
    public GenericMqttClient getProductiveGenericMqttClient(final HiveMqttClientProperties hiveMqttClientProperties) {
    ...
    @Override
    public GenericMqttClient getGenericMqttClientForConnectionTesting(
