 ...
 */
@Immutable
final class GenericMqttSubscription {
     ...
     */
    static GenericMqttSubscription newInstance(final MqttTopicFilter mqttTopicFilter, final MqttQos mqttQos) {
        return new GenericMqttSubscription(checkNotNull(mqttTopicFilter, "mqttTopicFilter"),
                checkNotNull(mqttQos, "mqttQos"));
    }

    MqttTopicFilter getMqttTopicFilter() {
    ...
    Mqtt3Subscription getAsMqtt3Subscription() {
    ...
    Mqtt5Subscription getAsMqtt5Subscription() {
