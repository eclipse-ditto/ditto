...
public final class HiveMqttClientProperties {
    ...
    private final MqttClientConnectedListener mqttClientConnectedListener;
    private final MqttClientDisconnectedListener mqttClientDisconnectedListener;
    ...
    public MqttClientConnectedListener getMqttClientConnectedListener() {
        return mqttClientConnectedListener;
    }

    public MqttClientDisconnectedListener getMqttClientDisconnectedListener() {
    ...
    private static final class Builder implements HiveMqttClientPropertiesStepBuilder.MqttConnectionStep,
        ...
        private MqttClientConnectedListener mqttClientConnectedListener;
        private MqttClientDisconnectedListener mqttClientDisconnectedListener;
        ...
        private Builder() {
            ...
            mqttClientConnectedListener = context -> {/* Do nothing.*/};
            mqttClientDisconnectedListener = context -> {/* Do nothing.*/};
            actorUuid = null;
        }
        ...
        public HiveMqttClientPropertiesStepBuilder.BuildableStep withClientConnectedListener(
                final MqttClientConnectedListener mqttClientConnectedListener
        ) {
        ...
        public HiveMqttClientPropertiesStepBuilder.BuildableStep withClientDisconnectedListener(
                final MqttClientDisconnectedListener mqttClientDisconnectedListener
        ) {
