...
/**
 * This package is reserved for the algebraic data type {@code MappingOutcome}
 * so that concrete implementations of {@code MappingOutcome} are not visible elsewhere.
 */
