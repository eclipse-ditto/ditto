...
public final class CloudEventsMapper extends AbstractMessageMapper {
    ...
    public static final MappingContext CONTEXT = ConnectivityModelFactory.newMappingContextBuilder(
            CloudEventsMapper.class.getCanonicalName(),
            DEFAULT_OPTIONS
    ).build();
...
//        String data = "{\"topic\":\"org.eclipse.ditto/sensor/things/twin/commands/modify\",\"path\":\"/\",\"value\":53}";
//        String data_base64 = Base64.getEncoder().withoutPadding().encodeToString(data.getBytes(StandardCharsets.UTF_8));
//////        System.out.println(data_base64);
////       String f = "";
...
//        String test2 = "{\"specversion\": \"1.0\", \"id\":\"3212e\", \"source\":\"http:somesite.com\",\"type\":\"com.site.com\",\"data_base64\":\"\"}";
//        extractData(test2);
//
    ...
    private JsonifiableAdaptable extractData(final String message) {
        ...
        if (payloadJson.getValue("data_base64").isPresent()) {
            try {
                ...
                final JsonifiableAdaptable decodedJsonifiableAdaptable = DittoJsonException.wrapJsonRuntimeException(() ->
