...
/**
 * This exception is thrown to indicate that an error occurred during transformation of a MQTT {@code PUBLISH} message
...
public class MqttPublishTransformationException extends RuntimeException {
    ...
    /**
     * Indicates whether this {@code MqttPublishTransformationException} is caused by a {@code DittoRuntimeException}.
     *
     * @return {@code true} if this exception is caused by a {@code DittoRuntimeException}, {@code false} else.
     */
    public boolean isCausedByDittoRuntimeException() {
        return getCause() instanceof DittoRuntimeException;
    }
