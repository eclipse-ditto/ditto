...
public final class HiveMqttClientFactoryTest {
    ...
    private static final String USERNAME = "alukah";
    ...
    @Mock private MqttClientConnectedListener mqttClientConnectedListener;
    @Mock private MqttClientDisconnectedListener mqttClientDisconnectedListener;
    ...
    public void getMqtt3ClientWithNullHiveMqttClientPropertiesThrowsException() {
        Assertions.assertThatNullPointerException()
                .isThrownBy(() -> HiveMqttClientFactory.getMqtt3Client(null, MQTT_CLIENT_IDENTIFIER, false))
    ...
    public void getMqtt3ClientWithoutLastWillWithoutSslReturnsExpected() throws NoMqttConnectionException {
        ...
        final var underTest =
                HiveMqttClientFactory.getMqtt3Client(hiveMqttClientProperties, MQTT_CLIENT_IDENTIFIER, false);
    ...
    public void getMqtt3ClientWithLastWillWithoutSslReturnsExpected() throws NoMqttConnectionException {
        ...
        final var underTest =
                HiveMqttClientFactory.getMqtt3Client(hiveMqttClientProperties, MQTT_CLIENT_IDENTIFIER, true);
    ...
    public void getMqtt5ClientWithoutLastWillWithoutSslReturnsExpected() throws NoMqttConnectionException {
        ...
        final var underTest =
                HiveMqttClientFactory.getMqtt5Client(hiveMqttClientProperties, MQTT_CLIENT_IDENTIFIER, false);
    ...
    public void getMqtt5ClientWithLastWillWithoutSslReturnsExpected() throws NoMqttConnectionException {
        ...
        final var underTest =
                HiveMqttClientFactory.getMqtt5Client(hiveMqttClientProperties, MQTT_CLIENT_IDENTIFIER, true);
