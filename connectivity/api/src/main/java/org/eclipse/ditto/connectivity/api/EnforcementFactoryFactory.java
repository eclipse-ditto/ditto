...
public final class EnforcementFactoryFactory {
     ...
     * for the filters:
     * <ul>
     * <li>{@link org.eclipse.ditto.connectivity.api.placeholders.ThingPlaceholder}</li>
     * <li>{@link org.eclipse.ditto.connectivity.api.placeholders.PolicyPlaceholder}</li>
     * <li>{@link org.eclipse.ditto.connectivity.api.placeholders.EntityIdPlaceholder}</li>
     * </ul>
     *
     * @param <I> the type from which the input values are resolved
