...
public final class ConnectionModified extends AbstractConnectivityEvent<ConnectionModified>
    ...
    private ConnectionModified(final Connection connection,
            final long revision,
     ...
     */
    public static ConnectionModified of(final Connection connection,
            final long revision,
            @Nullable final Instant timestamp,
            final DittoHeaders dittoHeaders,
            @Nullable final Metadata metadata) {
        checkNotNull(connection, "Connection");
        return new ConnectionModified(connection, revision, timestamp, dittoHeaders, metadata);
    }
    ...
    public static ConnectionModified fromJson(final JsonObject jsonObject, final DittoHeaders dittoHeaders) {
        return new EventJsonDeserializer<ConnectionModified>(TYPE, jsonObject)
                .deserialize((revision, timestamp, metadata) -> {
                    final JsonObject connectionJsonObject = jsonObject.getValueOrThrow(
                            ConnectivityEvent.JsonFields.CONNECTION);
    ...
    @Override
    public ConnectionModified setEntity(final JsonValue entity) {
    ...
    @Override
    public ConnectionModified setRevision(final long revision) {
