...
public final class ResetConnectionMetricsResponse extends AbstractCommandResponse<ResetConnectionMetricsResponse>
    ...
    private static final CommandResponseJsonDeserializer<ResetConnectionMetricsResponse> JSON_DESERIALIZER =
            CommandResponseJsonDeserializer.newInstance(TYPE,
                    context -> {
                        final JsonObject jsonObject = context.getJsonObject();
                        return new ResetConnectionMetricsResponse(
    ...
    private ResetConnectionMetricsResponse(final ConnectionId connectionId,
        ...
        super(TYPE,
                CommandResponseHttpStatusValidator.validateHttpStatus(httpStatus,
                        ...
                        ResetConnectionMetricsResponse.class),
                dittoHeaders);
    ...
    public static ResetConnectionMetricsResponse of(final ConnectionId connectionId, final DittoHeaders dittoHeaders) {
        return new ResetConnectionMetricsResponse(checkNotNull(connectionId, "connectionId"),
                HTTP_STATUS,
                dittoHeaders);
    }
