...
public final class ResumeSource {
    ...
    private static final class StatefulBackoffFunction<E>
            implements org.apache.pekko.japi.function.Function<E, Iterable<Pair<E, Duration>>> {
    ...
    private static final class StatefulLookBehindFunction<E> implements
            org.apache.pekko.japi.function.Function<Envelope<E>, Iterable<Either<FailureWithLookBehind<E>, E>>> {
