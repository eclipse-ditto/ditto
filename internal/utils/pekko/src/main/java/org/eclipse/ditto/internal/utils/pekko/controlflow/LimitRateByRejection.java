...
public final class LimitRateByRejection {
    ...
    private static final class Logic<A, E> implements org.apache.pekko.japi.function.Function<A, Iterable<Either<E, A>>> {
        ...
        private static <A, E> Creator<org.apache.pekko.japi.function.Function<A, Iterable<Either<E, A>>>> creator(
