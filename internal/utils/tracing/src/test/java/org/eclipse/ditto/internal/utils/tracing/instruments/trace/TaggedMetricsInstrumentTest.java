...
/**
 * Tests common to all implementations of TraceTags.
 *
 * @param <T> the implementation type of TraceTags
 */
abstract class TaggedMetricsInstrumentTest<T extends TraceTags<?>> {
