...
import org.eclipse.ditto.services.utils.persistence.operations.PersistenceOperationsConfig.PersistenceOperationsConfigValue;
...
public final class DefaultPersistenceOperationsConfigTest {
    ...
    public void underTestReturnsDefaultValuesIfBaseConfigWasEmpty() {
        ...
        softly.assertThat(underTest.getDelayAfterPersistenceActorShutdown())
                .as(PersistenceOperationsConfigValue.DELAY_AFTER_PERSISTENCE_ACTOR_SHUTDOWN.getConfigPath())
                .isEqualTo(PersistenceOperationsConfigValue.DELAY_AFTER_PERSISTENCE_ACTOR_SHUTDOWN.getDefaultValue());
    }
