...
/**
 * Defines a function expression used in a ArrayPipeline after the "input" stage of a resolved {@link Placeholder}, e.g.
 * function expressions are expressions like {@code fn:split(',')} or {@code fn:default('iot-things')}. Used in a
 * array pipeline expression like in the following example:
 * <pre>
 * {@code
 * jwt:scope | fn:split(',') | fn:default('iot-things')
 * }
 * </pre>
 */
