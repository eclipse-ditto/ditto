...
public interface ArrayPipeline {
     ...
     * @return the results of the Pipeline execution after all stages were handled.
     */
    Stream<PipelineElement> execute(PipelineElement pipelineInput, ExpressionResolver expressionResolver);
