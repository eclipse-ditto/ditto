...
//    }
    ...
    public void tryToGetValueAsIntWithWrongType() {
        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsInt, KNOWN_JSON_KEY,
                "int");
    }

//    @Test
//    public void tryToGetOptionalValueAsIntWithWrongType() {
//        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsOptionalInt,
//                KNOWN_JSON_KEY, "int");
//    }
...
//    }
    ...
    public void tryToGetValueAsLongWithWrongType() {
        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsLong, KNOWN_JSON_KEY,
                "long");
    }

//    @Test
//    public void tryToGetOptionalValueAsLongWithWrongType() {
//        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsOptionalLong,
//                KNOWN_JSON_KEY, "long");
//    }
...
//        final Optional<Long> optionalValue = newReaderForValue(JsonFactory.newValue(KNOWN_LONG_VALUE))
//                .getAsOptionalLong(KNOWN_JSON_KEY);
//
...
//    }
    ...
    public void tryToGetValueAsDoubleWithWrongType() {
        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsDouble,
                KNOWN_JSON_KEY, "double");
    }

//    @Test
//    public void tryToGetOptionalValueAsDoubleWithWrongType() {
//        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsOptionalDouble,
//                KNOWN_JSON_KEY, "double");
//    }

    @Test
    public void getAsDoubleReturnsExpected() {
        final double actualValue = newReaderForValue(JsonFactory.newValue(KNOWN_DOUBLE_VALUE))
                .getAsDouble(KNOWN_JSON_KEY);
...
//    }
    ...
    public void tryToGetValueAsBooleanWithWrongType() {
        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsBoolean,
                KNOWN_JSON_KEY, "boolean");
    }

//    @Test
//    public void tryToGetOptionalValueAsBooleanWithWrongType() {
//        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsOptionalBoolean,
//                KNOWN_JSON_KEY, "boolean");
//    }

    @Test
    public void getAsBooleanReturnsExpected() {
        final boolean actualValue = newReaderForValue(JsonFactory.newValue(KNOWN_BOOLEAN_VALUE))
                .getAsBoolean(KNOWN_JSON_KEY);
...
//    }
    ...
    public void tryToGetValueAsJsonObjectWithWrongType() {
        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsJsonObject,
                KNOWN_JSON_KEY, "JSON object");
    }

//    @Test
//    public void tryToGetOptionalValueAsJsonObjectWithWrongType() {
//        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsOptionalJsonObject,
//                KNOWN_JSON_KEY, "JSON object");
//    }
...
//    }
    ...
    public void tryToGetValueAsJsonArrayWithWrongType() {
        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsJsonArray,
                KNOWN_JSON_KEY, "JSON array");
    }

//    @Test
//    public void tryToGetOptionalValueAsJsonArrayWithWrongType() {
//        expectJsonParseException(newReaderForValue(JsonFactory.newValue(KNOWN_STRING_VALUE))::getAsOptionalJsonArray,
//                KNOWN_JSON_KEY, "JSON array");
//    }
...
//    }
    ...
    private static void expectJsonMissingFieldException(final Function<JsonPointer, ?> getter, final JsonKey key) {
        try {
    ...
    private static void expectJsonParseException(final Function<JsonPointer, ?> getter, final JsonKey key,
            final String expectedType) {

        try {
            getter.apply(key.asPointer());
    ...
    private static void expectEmptyOptional(final Function<JsonPointer, Optional<?>> getter, final JsonKey key) {
        final Optional<?> result = getter.apply(key.asPointer());
