...
public final class RetrieveFeatureDesiredPropertyTest {
    ...
    private static final JsonObject KNOWN_JSON = JsonFactory.newObjectBuilder()
            ...
            .set(RetrieveFeatureDesiredProperty.JSON_FEATURE_ID, TestConstants.Feature.FLUX_CAPACITOR_ID)
    ...
    public void tryToCreateInstanceWithNullThingId() {
        RetrieveFeatureDesiredProperty.of(ThingId.of(null), TestConstants.Feature.FLUX_CAPACITOR_ID,
    ...
    public void tryToCreateInstanceWithNullJsonPointer() {
        RetrieveFeatureDesiredProperty.of(TestConstants.Thing.THING_ID, TestConstants.Feature.FLUX_CAPACITOR_ID, null,
                TestConstants.EMPTY_DITTO_HEADERS);
    }

    @Test
    public void tryToCreateInstanceWithValidArguments() {
        RetrieveFeatureDesiredProperty.of(TestConstants.Thing.THING_ID, TestConstants.Feature.FLUX_CAPACITOR_ID,
