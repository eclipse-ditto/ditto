 ...
 */
@JsonParsableException(errorCode = FeaturesNotModifiableException.ERROR_CODE)
public final class FeaturesNotModifiableException extends DittoRuntimeException implements ThingException {
     ...
     * @return the builder.
     */
    public static FeaturesNotModifiableException.Builder newBuilder(final ThingId thingId) {
     ...
     */
    public static FeaturesNotModifiableException fromMessage(@Nullable final String message,
