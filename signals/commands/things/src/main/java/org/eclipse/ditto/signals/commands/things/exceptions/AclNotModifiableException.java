...
public final class AclNotModifiableException extends DittoRuntimeException implements ThingException {
     ...
     */
    public static final String ERROR_CODE = ERROR_CODE_PREFIX + "acl.notmodifiable";

    private static final String MESSAGE_TEMPLATE =
            "The Access Control List of the Thing with ID ''{0}'' could not be " + "modified.";

    private static final String DEFAULT_DESCRIPTION =
            "Check if the ID of the thing was correct and you have " +
                    "sufficient permissions. If you wanted to modify the"
                    + " complete Thing, try modifying it without also changing the Access Control List ('acl').";
    ...
    /**
     * A mutable builder for a {@code AclNotModifiableException}.
     *
    ...
    /**
     * Constructs a new {@code AclNotModifiableException} object with the given exception message.
     *
     * @param message detail message. This message can be later retrieved by the {@link #getMessage()} method.
     * @param dittoHeaders the headers of the command which resulted in this exception.
     * @return the new AclNotModifiableException.
     */
    public static AclNotModifiableException fromMessage(final String message, final DittoHeaders dittoHeaders) {
        return new Builder()
    ...
    /**
     * Constructs a new {@code AclNotModifiableException} object with the exception message extracted from the
     * given JSON object.
     *
