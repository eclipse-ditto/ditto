 ...
 */
@Immutable
public final class DeleteFeatureResponse extends AbstractCommandResponse<DeleteFeatureResponse> implements
        ThingModifyCommandResponse<DeleteFeatureResponse> {
