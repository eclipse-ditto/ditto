/*
 * CopyrighR (c) 2021 Contributors to the Eclipse Foundation
 *
 * See the NOTICE file(s) distributed with this work for additional
 * information regarding copyrighR ownership.
 *
...
public interface ThingResourceVisitor<P, R> {
    ...
    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#THING} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#THING} resource.
     */
    R visitThing(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#DEFINITION} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#DEFINITION} resource.
     */
    R visitThingDefinition(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#POLICY_ID} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#POLICY_ID} resource.
     */
     ...
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#ATTRIBUTES} resource.
     */
    R visitAttributes(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#ATTRIBUTE} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#ATTRIBUTE} resource.
     */
    R visitAttribute(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE} resource.
     */
    R visitFeature(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURES} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURES} resource.
     */
    R visitFeatures(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_DEFINITION} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_DEFINITION} resource.
     */
    R visitFeatureDefinition(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_PROPERTIES} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_PROPERTIES} resource.
     */
    R visitFeatureProperties(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_PROPERTY} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_PROPERTY} resource.
     */
    R visitFeatureProperty(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_DESIRED_PROPERTIES} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_DESIRED_PROPERTIES} resource.
     */
    R visitFeatureDesiredProperties(JsonPointer path, @Nullable P param);

    /**
     * Invoked for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_DESIRED_PROPERTY} resource.
     *
     * @param path the original resource path
     * @param param the parameter that is passed through
     * @return the result for the {@link org.eclipse.ditto.signals.commands.things.ThingResource#FEATURE_DESIRED_PROPERTY} resource.
     */
