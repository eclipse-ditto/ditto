...
public class ThingMergeInvalidException extends DittoRuntimeException implements ThingException {
     ...
     * @return the builder.
     */
    public static ThingMergeInvalidException.Builder newBuilder() {
        return new ThingMergeInvalidException.Builder();
    }
    ...
    public static ThingMergeInvalidException fromMessage(@Nullable final String message,
        ...
        return DittoRuntimeException.fromMessage(message, dittoHeaders, new ThingMergeInvalidException.Builder());
    }
    ...
    public static ThingMergeInvalidException fromJson(final JsonObject jsonObject, final DittoHeaders dittoHeaders) {
        return DittoRuntimeException.fromJson(jsonObject, dittoHeaders, new ThingMergeInvalidException.Builder());
    }
