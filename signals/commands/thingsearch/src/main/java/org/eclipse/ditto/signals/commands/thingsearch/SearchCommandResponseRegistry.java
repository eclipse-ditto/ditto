...
public final class SearchCommandResponseRegistry extends AbstractCommandResponseRegistry<ThingSearchCommandResponse> {
    ...
    private SearchCommandResponseRegistry(final Map<String, JsonParsable<ThingSearchCommandResponse>> parseStrategies) {
    ...
    public static SearchCommandResponseRegistry newInstance() {
        ...
        // error responses
        parseStrategies.put(SearchErrorResponse.TYPE, SearchErrorResponse::fromJson);

        return new SearchCommandResponseRegistry(parseStrategies);
    }
