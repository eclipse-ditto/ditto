...
/**
 * Response to an {@link ActivatePolicyTokenIntegration} command.
 *
 * @since 2.0.0
 */
@Immutable
@JsonParsableCommandResponse(type = ActivatePolicyTokenIntegrationResponse.TYPE)
public final class ActivatePolicyTokenIntegrationResponse
        extends AbstractCommandResponse<ActivatePolicyTokenIntegrationResponse>
        implements PolicyActionCommandResponse<ActivatePolicyTokenIntegrationResponse> {

    /**
     * Type of this response.
     */
    public static final String TYPE = TYPE_PREFIX + ActivatePolicyTokenIntegration.NAME;
    ...
    /**
     * Creates a response to a {@code ActivatePolicyTokenIntegration} command from a JSON object.
     *
    ...
    public static ActivatePolicyTokenIntegrationResponse fromJson(final JsonObject jsonObject,
            final DittoHeaders dittoHeaders) {
    ...
    protected boolean canEqual(@Nullable final Object other) {
        return other instanceof ActivatePolicyTokenIntegrationResponse;
    }
