...
public final class ModifyPolicyImportResponse extends AbstractCommandResponse<ModifyPolicyImportResponse>
    ...
    private ModifyPolicyImportResponse(final String policyId,
     ...
     */
    public static ModifyPolicyImportResponse created(final String policyId, final PolicyImport policyImportCreated,
            final DittoHeaders dittoHeaders) {

        return new ModifyPolicyImportResponse(policyId, HttpStatusCode.CREATED, policyImportCreated, dittoHeaders);
    }
     ...
     */
    public static ModifyPolicyImportResponse modified(final String policyId, final DittoHeaders dittoHeaders) {
        return new ModifyPolicyImportResponse(policyId, HttpStatusCode.NO_CONTENT, null, dittoHeaders);
    }
        ...
        return new CommandResponseJsonDeserializer<ModifyPolicyImportResponse>(TYPE, jsonObject)
                .deserialize(statusCode -> {
                    ...
                    final PolicyImport extractedPolicyImportCreated = jsonObject.getValue(JSON_POLICY_IMPORT)
                            ...
                            .map(obj -> readImportedPolicyId.map(s -> PoliciesModelFactory.newPolicyImport(s, obj))
                                    .orElse(null))
                            .orElse(null);
    ...
    protected void appendPayload(final JsonObjectBuilder jsonObjectBuilder, final JsonSchemaVersion schemaVersion,
        ...
        if (null != policyImportCreated) {
            jsonObjectBuilder.set(JSON_IMPORTED_POLICY_ID, policyImportCreated.getImportedPolicyId(), predicate);
