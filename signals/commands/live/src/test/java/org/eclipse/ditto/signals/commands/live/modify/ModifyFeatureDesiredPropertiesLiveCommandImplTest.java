...
/**
 * Unit test for {@link ModifyFeatureDesiredPropertiesLiveCommandImpl}.
 */
public final class ModifyFeatureDesiredPropertiesLiveCommandImplTest {
    ...
    @Before
    public void setUp() {
        twinCommand = ModifyFeatureDesiredProperties.of(TestConstants.Thing.THING_ID, TestConstants.Feature.FLUX_CAPACITOR_ID,
