...
public final class ResetConnectionMetricsResponse extends AbstractCommandResponse<ResetConnectionMetricsResponse>
    ...
    private ResetConnectionMetricsResponse(final EntityId connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static ResetConnectionMetricsResponse of(final EntityId connectionId, final DittoHeaders dittoHeaders) {
