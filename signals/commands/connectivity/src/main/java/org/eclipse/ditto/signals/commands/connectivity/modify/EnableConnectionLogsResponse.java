...
/**
 * Response to a {@link org.eclipse.ditto.signals.commands.connectivity.modify.EnableConnectionLogs} command.
 */
@Immutable
...
public final class EnableConnectionLogsResponse extends AbstractCommandResponse<EnableConnectionLogsResponse>
    ...
    private EnableConnectionLogsResponse(final EntityId connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static EnableConnectionLogsResponse of(final EntityId connectionId, final DittoHeaders dittoHeaders) {
