...
public final class EnableConnectionLogs extends AbstractCommand<EnableConnectionLogs>
    ...
    private EnableConnectionLogs(final EntityId connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static EnableConnectionLogs of(final EntityId connectionId, final DittoHeaders dittoHeaders) {
