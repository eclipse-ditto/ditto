...
public final class ResetConnectionLogs extends AbstractCommand<ResetConnectionLogs>
     ...
     */
    public static final String NAME = "resetConnectionLogs";
    ...
    private ResetConnectionLogs(final EntityId connectionId, final DittoHeaders dittoHeaders) {
        super(TYPE, dittoHeaders);
        this.connectionId = connectionId;
    }

    /**
     * Creates a new instance of {@code ResetConnectionLogs}.
     *
     ...
     */
    public static ResetConnectionLogs of(final EntityId connectionId, final DittoHeaders dittoHeaders) {
        checkNotNull(connectionId, "Connection ID");
        return new ResetConnectionLogs(connectionId, dittoHeaders);
    }

    /**
     * Creates a new {@code ResetConnectionLogs} from a JSON string.
     ...
     * format.
     */
    public static ResetConnectionLogs fromJson(final String jsonString, final DittoHeaders dittoHeaders) {
        return fromJson(JsonFactory.newObject(jsonString), dittoHeaders);
    }

    /**
     * Creates a new {@code ResetConnectionLogs} from a JSON object.
    ...
    protected boolean canEqual(@Nullable final Object other) {
        return (other instanceof ResetConnectionLogs);
    }
    ...
    public boolean equals(@Nullable final Object o) {
        ...
        final ResetConnectionLogs that = (ResetConnectionLogs) o;
