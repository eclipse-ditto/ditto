...
public final class TestConnection extends AbstractCommand<TestConnection>
    ...
    private TestConnection(final Connection connection, @Nullable final MappingContext mappingContext,
     ...
     * @throws NullPointerException if any argument is {@code null}.
     */
    public static TestConnection of(final Connection connection, @Nullable final MappingContext mappingContext,
            final DittoHeaders dittoHeaders) {
        checkNotNull(connection, "Connection");
        return new TestConnection(connection, mappingContext, dittoHeaders);
    }
    ...
    /**
     * @return the configured {@link MappingContext} of the connection to be tested.
     */
