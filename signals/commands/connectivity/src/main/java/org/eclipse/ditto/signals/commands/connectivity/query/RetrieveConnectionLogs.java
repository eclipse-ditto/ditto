...
public final class RetrieveConnectionLogs extends AbstractCommand<RetrieveConnectionLogs>
    ...
    private RetrieveConnectionLogs(final EntityId connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static RetrieveConnectionLogs of(final EntityId connectionId, final DittoHeaders dittoHeaders) {
