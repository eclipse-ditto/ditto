...
/**
 * Command which retrieves the current/live {@link ConnectionStatus} and other connection specific metrics of an
...
public final class RetrieveConnectionMetrics extends AbstractCommand<RetrieveConnectionMetrics>
    ...
    private RetrieveConnectionMetrics(final String connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static RetrieveConnectionMetrics of(final String connectionId, final DittoHeaders dittoHeaders) {
