...
public final class RetrieveConnectionStatusesResponse
        ...
        implements ConnectivityQueryCommandResponse<RetrieveConnectionStatusesResponse> {

    /**
     * Type of this response.
     */
    public static final String TYPE = ConnectivityCommandResponse.TYPE_PREFIX + RetrieveConnectionStatuses.NAME;
    ...
    protected boolean canEqual(@Nullable final Object other) {
        return (other instanceof RetrieveConnectionStatusesResponse);
    }
