...
public final class ResetConnectionMetrics extends AbstractCommand<ResetConnectionMetrics>
    ...
    private ResetConnectionMetrics(final String connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static ResetConnectionMetrics of(final String connectionId, final DittoHeaders dittoHeaders) {
