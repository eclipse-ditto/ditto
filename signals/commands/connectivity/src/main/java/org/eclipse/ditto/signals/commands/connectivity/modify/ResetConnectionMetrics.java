...
public final class ResetConnectionMetrics extends AbstractCommand<ResetConnectionMetrics>
    ...
    private ResetConnectionMetrics(final EntityId connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static ResetConnectionMetrics of(final EntityId connectionId, final DittoHeaders dittoHeaders) {
