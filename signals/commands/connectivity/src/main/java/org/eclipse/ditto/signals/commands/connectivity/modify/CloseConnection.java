...
public final class CloseConnection extends AbstractCommand<CloseConnection>
    ...
    private CloseConnection(final EntityId connectionId, final DittoHeaders dittoHeaders) {
     ...
     */
    public static CloseConnection of(final EntityId connectionId, final DittoHeaders dittoHeaders) {
