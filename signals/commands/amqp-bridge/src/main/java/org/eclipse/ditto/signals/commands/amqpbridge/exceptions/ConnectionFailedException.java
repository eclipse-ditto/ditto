...
/**
 * Thrown if a {@link AmqpConnection} failed to connect.
 */
@Immutable
public final class ConnectionFailedException extends DittoRuntimeException implements AmqpBridgeException {
     ...
     */
    public static ConnectionFailedException fromMessage(final String message, final DittoHeaders dittoHeaders) {
        return new Builder()
