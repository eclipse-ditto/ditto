 ...
 * {@link AmqpBridgeQueryCommand}.
 *
 * @param <T> the type of the implementing class.
 */
public interface AmqpBridgeQueryCommandResponse<T extends AmqpBridgeQueryCommandResponse> extends
        AmqpBridgeCommandResponse<T>, WithEntity {
