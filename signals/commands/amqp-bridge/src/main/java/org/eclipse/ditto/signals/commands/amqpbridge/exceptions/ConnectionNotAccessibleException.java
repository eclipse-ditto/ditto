...
/**
 * Thrown if a {@link AmqpConnection} is not present.
 */
@Immutable
public final class ConnectionNotAccessibleException extends DittoRuntimeException implements AmqpBridgeException {
