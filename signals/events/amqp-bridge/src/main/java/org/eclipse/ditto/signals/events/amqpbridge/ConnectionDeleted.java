...
/**
 * This event is emitted after a {@link AmqpConnection} was deleted.
 */
@Immutable
public final class ConnectionDeleted extends AbstractAmqpBridgeEvent<ConnectionDeleted>
        implements AmqpBridgeEvent<ConnectionDeleted> {
