...
/**
 * Abstract base class of a {@link AmqpConnection} related event.
 *
 * @param <T> the type of the implementing class.
 */
@Immutable
public abstract class AbstractAmqpBridgeEvent<T extends AbstractAmqpBridgeEvent> implements AmqpBridgeEvent<T> {
    ...
    /**
     * Constructs a new {@code AbstractAmqpBridgeEvent} object.
     *
     ...
     */
    protected AbstractAmqpBridgeEvent(final String type, final String connectionId,
    ...
    /**
     * Returns the identifier of this event's {@code AmqpBridge}.
     *
     * @return the identifier of this event's AmqpBridge.
     */
    @Override
    ...
    public boolean equals(@Nullable final Object o) {
        ...
        final AbstractAmqpBridgeEvent
                that = (AbstractAmqpBridgeEvent) o;
    ...
    protected boolean canEqual(@Nullable final Object other) {
        return (other instanceof AbstractAmqpBridgeEvent);
    }
