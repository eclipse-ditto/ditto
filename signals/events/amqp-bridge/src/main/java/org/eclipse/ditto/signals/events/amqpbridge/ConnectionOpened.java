...
/**
 * This event is emitted after a {@link AmqpConnection} was opened.
 */
@Immutable
public final class ConnectionOpened extends AbstractAmqpBridgeEvent<ConnectionOpened>
        implements AmqpBridgeEvent<ConnectionOpened> {
