...
/**
 * Unit test for {@link AclEntryModified}.
 */
public final class AclEntryModifiedTest {
    ...
    public void assertImmutability() {
        assertInstancesOf(AclEntryModified.class,
                areImmutable(),
    ...
    public void testHashCodeAndEquals() {
        ...
        EqualsVerifier.forClass(AclEntryModified.class)
    ...
    public void tryToCreateInstanceWithNullThingIdString() {
        AclEntryModified.of((String) null, TestConstants.Authorization.ACL_ENTRY_OLDMAN, TestConstants.Thing.REVISION_NUMBER,
                TestConstants.EMPTY_DITTO_HEADERS);
    }

    @Test(expected = NullPointerException.class)
    public void tryToCreateInstanceWithNullThingId() {
        AclEntryModified.of((ThingId) null, TestConstants.Authorization.ACL_ENTRY_OLDMAN, TestConstants.Thing.REVISION_NUMBER,
                TestConstants.EMPTY_DITTO_HEADERS);
    }
    ...
    public void createInstanceFromValidJson() {
        final AclEntryModified underTest =
                AclEntryModified.fromJson(KNOWN_JSON.toString(), TestConstants.EMPTY_DITTO_HEADERS);
