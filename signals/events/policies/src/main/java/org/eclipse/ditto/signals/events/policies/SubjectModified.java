...
public final class SubjectModified extends AbstractPolicyEvent<SubjectModified>
     ...
     * @throws org.eclipse.ditto.json.JsonParseException if the passed in {@code jsonString} was not in the expected 'SubjectModified' format.
     */
    ...
    public static SubjectModified fromJson(final JsonObject jsonObject, final DittoHeaders dittoHeaders) {
        return new EventJsonDeserializer<SubjectModified>(TYPE, jsonObject).deserialize((revision, timestamp, metadata) -> {
     ...
     *
     * @return the modified {@link Subject}.
     */
