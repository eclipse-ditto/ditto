...
public final class MultiStageCommandTest {
    ...
    private static final String THING_SUDO =
            SudoCommand.RESOURCE_TYPE;
    private static final String POLICY_SUDO =
            org.eclipse.ditto.policies.api.commands.sudo.SudoCommand.RESOURCE_TYPE;
    ...
    private ActorRef newEnforcerActor(final ActorRef testActorRef) {
        return TestSetup.newEnforcerActor(system, testActorRef, mockThingsActor, mockPoliciesActor, null, null);
    }
