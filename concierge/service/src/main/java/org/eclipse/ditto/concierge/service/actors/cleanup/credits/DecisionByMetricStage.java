...
final class DecisionByMetricStage {
     ...
     * <li>based in that max time a {@link org.eclipse.ditto.concierge.service.actors.cleanup.messages.CreditDecision} is made based on the passed {@code timerThreshold}</li>
     * <li>if the extracted max time from {@link StatusInfo} is lesser than the passed in {@code timerThreshold},
     * a positive {@link org.eclipse.ditto.concierge.service.actors.cleanup.messages.CreditDecision} is emitted to the outlet with the passed in {@code creditPerBatch}</li>
     * <li>if the extracted max time from {@link StatusInfo} is greater than the passed {@code timerThreshold},
     * a negative {@link org.eclipse.ditto.concierge.service.actors.cleanup.messages.CreditDecision} is emitted to the outlet</li>
     * </ul>
     *
     * @param timerThreshold the duration defining the threshold below which a positive {@link org.eclipse.ditto.concierge.service.actors.cleanup.messages.CreditDecision} is
     * emitted by this stage.
     * @param creditPerBatch the batch credit which will be included in a positive {@link org.eclipse.ditto.concierge.service.actors.cleanup.messages.CreditDecision}.
