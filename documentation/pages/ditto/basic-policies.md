...
{% include note.html content="The policy concept is only supported for Eclipse Ditto **HTTP API version 2**. <br/>
Find the API reference at [Policies resources TODO link](foobar)." %}
