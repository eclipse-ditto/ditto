...
```json
{
  ...
  "value": {
    ...
    "message": "The Subject with ID 'https://accounts.google.com:the_subjectid' of the PolicyEntry with Label 'the_label' on the Policy with ID 'com.acme:the_policy_id' could not be modified as the requester had insufficient permissions.",
