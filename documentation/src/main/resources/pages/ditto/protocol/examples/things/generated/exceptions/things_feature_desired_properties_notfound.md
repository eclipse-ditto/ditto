...
```json
{
  ...
  "value": {
    ...
    "message": "The desired properties of the Feature with ID 'accelerometer' on the Thing with ID 'com.acme:xdk_53' do not exist or the requester had insufficient permissions to access it.",
