...
```json
{
  ...
  "value": {
    ...
    "message": "The desired properties of the Feature with ID 'accelerometer' on the Thing with ID 'com.acme:xdk_53' cannot be modified as the requester had insufficient permissions to modify it (WRITE is required).",
