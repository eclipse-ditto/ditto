...
During inbound payload mapping you create one or more Ditto Protocol messages. 
...
[Requesting via Ditto Protocol message](#requesting-via-ditto-protocol-message) section) during payload mapping for 
