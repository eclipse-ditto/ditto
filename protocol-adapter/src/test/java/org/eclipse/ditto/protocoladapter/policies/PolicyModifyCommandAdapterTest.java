...
public final class PolicyModifyCommandAdapterTest implements ProtocolAdapterTest {
    ...
    public void unknownCommandToAdaptable() {
        underTest.toAdaptable(new UnknownPolicyModifyCommand());
    }

    private static class UnknownPolicyModifyCommand implements PolicyModifyCommand {
        ...
        @Override
        public PolicyModifyCommand setDittoHeaders(final DittoHeaders dittoHeaders) {
            return this;
        }
