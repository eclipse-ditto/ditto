...
final class PolicyErrorResponseAdapter extends AbstractErrorResponseAdapter<PolicyErrorResponse> {
    ...
    @Override
    TopicPathBuilder getTopicPathBuilder(final PolicyErrorResponse errorResponse) {
        return ProtocolFactory.newTopicPathBuilder(errorResponse.getEntityId());
    }

    @Override
    PolicyErrorResponse buildErrorResponse(final TopicPath topicPath, final DittoRuntimeException exception,
