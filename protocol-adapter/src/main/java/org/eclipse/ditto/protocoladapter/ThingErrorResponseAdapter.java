...
final class ThingErrorResponseAdapter extends AbstractErrorResponseAdapter<ThingErrorResponse> {
    ...
    @Override
    TopicPathBuilder getTopicPathBuilder(final ThingErrorResponse errorResponse) {
        return ProtocolFactory.newTopicPathBuilder(errorResponse.getThingEntityId());
    }

    @Override
    ThingErrorResponse buildErrorResponse(final TopicPath topicPath, final DittoRuntimeException exception,
