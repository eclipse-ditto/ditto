...
abstract class AbstractPolicyAdapter<T extends Jsonifiable & WithId> extends AbstractAdapter<T> {
    ...
    protected AbstractPolicyAdapter(final Map<String, JsonifiableMapper<T>> mappingStrategies,
        ...
        super(mappingStrategies, headerTranslator, new PathMatcher(POLICY_PATH_PATTERNS));
