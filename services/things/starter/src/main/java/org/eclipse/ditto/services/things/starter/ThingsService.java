        ...
        Cluster.get(system).registerOnMemberUp(() ->
        {
            ...
            if (config.hasPath(ConfigKeys.StatsD.HOSTNAME)) {
                ...
                final MetricRegistry registry =
                        ((MongoPersistenceExtension) MongoPersistenceExtension$.MODULE$.apply(system)).configured(
                                config)
                                .registry();
                ...
                final StatsDReporter metricsReporter = StatsDReporter.forRegistry(registry)
                        ...
                        .prefixedWith(SERVICE_NAME + "." + ConfigUtil.calculateInstanceUniqueSuffix())
            ...
            system.actorOf(ThingsRootActor.props(config, pubSubMediator, materializer), ThingsRootActor.ACTOR_NAME);
        });
    }
