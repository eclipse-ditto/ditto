 ...
 */
@ThreadSafe
final class AttributeModifiedStrategy implements HandleStrategy<AttributeModified> {

    @Override
    public Thing handle(final AttributeModified event, final Thing thing, final long revision) {
