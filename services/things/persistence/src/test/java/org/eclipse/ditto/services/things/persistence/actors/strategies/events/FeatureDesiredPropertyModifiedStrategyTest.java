...
public final class FeatureDesiredPropertyModifiedStrategyTest extends AbstractStrategyTest {
    ...
    public void appliesEventCorrectly() {
        ...
        final FeatureDesiredPropertyModified event = FeatureDesiredPropertyModified.of(THING_ID, FEATURE_ID, FEATURE_PROPERTY_POINTER,
                FEATURE_PROPERTY_VALUE, REVISION, null, DittoHeaders.empty(), null);

        final Thing thingWithEventApplied = strategy.handle(event, THING, NEXT_REVISION);

        final Thing expected = THING.toBuilder()
                .setFeatureDesiredProperty(FEATURE_ID, FEATURE_PROPERTY_POINTER, FEATURE_PROPERTY_VALUE)
