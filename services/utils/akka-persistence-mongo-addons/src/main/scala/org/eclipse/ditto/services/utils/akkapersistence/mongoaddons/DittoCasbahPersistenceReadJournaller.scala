...
object SequenceNumbersOfPidsByInterval {
  ...
  def props(driver: DittoCasbahMongoDriver, start: Instant, end: Instant): Props =
...
/**
  ...
  */
class SequenceNumbersOfPidsByInterval(val driver: DittoCasbahMongoDriver, start: Instant, end: Instant)
...
/**
  ...
  * queries.
  *
  * @param driver the DittoDittoCasbahMongoDriver to use.
  */
class DittoCasbahPersistenceReadJournaller(driver: DittoCasbahMongoDriver)
  extends CasbahPersistenceReadJournaller(driver)
    with DittoMongoPersistenceReadJournallingApi {
