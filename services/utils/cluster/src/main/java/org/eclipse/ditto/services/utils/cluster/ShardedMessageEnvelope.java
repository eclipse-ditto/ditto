...
public final class ShardedMessageEnvelope
     ...
     */
    public static final JsonFieldDefinition JSON_ID = JsonFieldDefinition.newInstance("id", String.class);

    /**
     * JSON field containing the type of the message of a {@code ShardedMessageEnvelope}.
     */
    public static final JsonFieldDefinition JSON_TYPE = JsonFieldDefinition.newInstance("type", String.class);

    /**
     * JSON field containing the message of a {@code ShardedMessageEnvelope}.
     */
    public static final JsonFieldDefinition JSON_MESSAGE = JsonFieldDefinition.newInstance("message", JsonObject.class);
    ...
    private ShardedMessageEnvelope(final String id, final String type, final JsonObject message,
     ...
     */
    public static ShardedMessageEnvelope of(final String id, final String type, final JsonObject message,
            final DittoHeaders dittoHeaders) {
    ...
    public static ShardedMessageEnvelope fromJson(final JsonObject jsonObject) {
        ...
        final String extractedId = reader.get(JSON_ID);
        final String extractedType = reader.get(JSON_TYPE);
        final JsonObject extractedMessage = reader.get(JSON_MESSAGE);
        final JsonObject jsonDittoHeaders = reader.get(JSON_DITTO_HEADERS);
