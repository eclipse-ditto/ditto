...
import static org.eclipse.ditto.services.models.things.TestConstants.Thing.THING;
...
public final class ThingSnapshotTakenTest {
    ...
    public void gettersReturnExpected() {
        ...
        softly.assertThat((CharSequence) underTest.getEntityId()).as("entity ID").isEqualTo(THING_ID);
    ...
    public void toJsonReturnsExpected() {
        ...
        final var jsonObject = JsonObject.newBuilder()
                ...
                .set(Event.JsonFields.REVISION, underTest.getRevision())
    ...
    public void fromJsonWorksAsExpected() {
        ...
        final var thingSnapshotTaken =
                ThingSnapshotTaken.newBuilder(THING_ID, REVISION, PersistenceLifecycle.ACTIVE, thingJson)
                        .timestamp(timestamp)
                        .dittoHeaders(dittoHeaders)
                        .build();
