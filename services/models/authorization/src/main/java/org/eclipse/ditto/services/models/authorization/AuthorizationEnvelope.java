...
/**
 * Wrap messages and send them to authorization service.
 */
public final class AuthorizationEnvelope {
    ...
    /**
     * Create an object to dispatch messages to authorization service.
     *
     * @param pubSubMediator Akka pub-sub mediator.
     * @param enforcerShardRegion shard region of enforcer actors.
     */
    public AuthorizationEnvelope(final ActorRef pubSubMediator, final ActorRef enforcerShardRegion) {
