...
public final class ThingModifyTwinCommandAcknowledgementAggregatorActorStarter
        extends AbstractAcknowledgementAggregatorActorStarter<ThingModifyCommand<?>> {

    private ThingModifyTwinCommandAcknowledgementAggregatorActorStarter(final ActorContext context,
            final ThingModifyCommand<?> signal,
     ...
     */
    static ThingModifyTwinCommandAcknowledgementAggregatorActorStarter getInstance(final ActorContext context,
            final ThingModifyCommand<?> thingModifyCommand,
            final AcknowledgementConfig acknowledgementConfig,
            final HeaderTranslator headerTranslator,
            final Consumer<Object> responseSignalConsumer) {

        return new ThingModifyTwinCommandAcknowledgementAggregatorActorStarter(context, thingModifyCommand,
