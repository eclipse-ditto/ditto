...
/**
 * This class is the default implementation for the config of the {@code inbox/claim} resource of the Things service.
 */
@Immutable
public final class DefaultClaimMessageConfig implements MessageConfig, Serializable  {

    private static final String CONFIG_PATH = "claim-message";

    private static final long serialVersionUID = 6101799221924124008L;
