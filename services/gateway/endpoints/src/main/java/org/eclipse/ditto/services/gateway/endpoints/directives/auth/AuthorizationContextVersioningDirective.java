...
public final class AuthorizationContextVersioningDirective {
    ...
    private static AuthorizationContext mapAuthorizationContext(
            final AuthorizationContext authenticationContextWithPrefixedSubjects, final JsonSchemaVersion version) {

        final List<AuthorizationSubject> subjectsWithoutPrefix = authenticationContextWithPrefixedSubjects.stream()
        ...
        if (JsonSchemaVersion.V_1 == version) {
