...
public interface WebSocketSupervisor {
     ...
     *
     * @param webSocketActor the WebSocket actor to be supervised.
     ...
     */
    void supervise(ActorRef webSocketActor, CharSequence connectionCorrelationId, DittoHeaders dittoHeaders);
