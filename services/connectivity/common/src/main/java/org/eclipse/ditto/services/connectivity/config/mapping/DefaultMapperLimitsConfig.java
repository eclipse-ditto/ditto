...
package org.eclipse.ditto.services.connectivity.config.mapping;
...
public class DefaultMapperLimitsConfig implements MapperLimitsConfig {
    ...
    private DefaultMapperLimitsConfig(final ScopedConfig config) {
        ...
        maxSourceMappers = config.getInt(MapperLimitsConfig.MapperLimitsConfigValue.MAX_SOURCE_MAPPERS.getConfigPath());
        maxMappedInboundMessages =
                config.getInt(MapperLimitsConfig.MapperLimitsConfigValue.MAX_MAPPED_INBOUND_MESSAGE.getConfigPath());
        maxTargetMappers = config.getInt(MapperLimitsConfig.MapperLimitsConfigValue.MAX_TARGET_MAPPERS.getConfigPath());
        maxMappedOutboundMessages =
                config.getInt(MapperLimitsConfig.MapperLimitsConfigValue.MAX_MAPPED_OUTBOUND_MESSAGE.getConfigPath());
    }
    ...
    public static DefaultMapperLimitsConfig of(final Config config) {
        return new DefaultMapperLimitsConfig(
                ConfigWithFallback.newInstance(config, CONFIG_PATH,
                        MapperLimitsConfig.MapperLimitsConfigValue.values()));
    }
