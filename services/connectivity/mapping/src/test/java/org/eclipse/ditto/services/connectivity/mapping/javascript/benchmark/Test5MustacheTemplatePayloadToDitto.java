...
public class Test5MustacheTemplatePayloadToDitto implements MapToDittoProtocolScenario {
    ...
    private static final String MAPPING_INCOMING_PLAIN =
            "function mapToDittoProtocolMsg(\n" +
                    ...
                    "       }\n" +
                    "    };\n" +
                    "    let value = Mustache.render('{{title}} spends {{calc}}', input);\n" +
                    "    // ###\n" +
                    "\n" +
    ...
    public Test5MustacheTemplatePayloadToDitto() {
    ...
    public MessageMapper getMessageMapper() {
        ...
        javaScriptRhinoMapperPlain.configureWithValidation(
                JavaScriptMessageMapperFactory
                        ...
                        .loadMustacheJS(true) // with mustache!
                        .build()
        );
