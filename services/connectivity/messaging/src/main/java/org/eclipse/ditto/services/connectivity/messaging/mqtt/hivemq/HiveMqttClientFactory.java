...
interface HiveMqttClientFactory<Q, B> {
     ...
     */
    Q newClient(Connection connection, String identifier, boolean allowReconnect, boolean applyLastWillConfig,
    ...
    default Q newClient(final Connection connection, final String identifier, final boolean allowReconnect,
            final boolean applyLastWillConfig, final ConnectionLogger connectionLogger) {
        return newClient(connection, identifier, allowReconnect, applyLastWillConfig, null, null, connectionLogger);
    }
