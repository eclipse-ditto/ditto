 ...
 *     would respond with an {@link IsInBackOffResponse} telling you the actor is currently in back-off mode.</li>
...
public final class BackOffActor extends AbstractActorWithTimers {
     ...
     * a message backed off and respond with an instance of {@link IsInBackOffResponse}.
     *
