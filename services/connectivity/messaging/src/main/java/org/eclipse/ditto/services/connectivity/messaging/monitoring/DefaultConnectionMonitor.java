...
/**
 * Default implementation of {@link org.eclipse.ditto.services.connectivity.messaging.monitoring.ConnectionMonitor}.
 */
public final class DefaultConnectionMonitor implements ConnectionMonitor {
     ...
     */
    public static ConnectionMonitor.Builder builder(final ConnectionMetricsCounter counter, final ConnectionLogger logger) {
     ...
     */
    private static class ConnectionMonitorBuilder implements ConnectionMonitor.Builder {
