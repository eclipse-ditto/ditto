...
public final class ConnectionPersistenceActorTest extends WithMockServers {
    ...
    public void manageConnection() {
        new TestKit(actorSystem) {{
            ...
            final ActorRef underTest =
                    TestConstants.createConnectionSupervisorActor(connectionId, actorSystem, pubSubMediator,
                            conciergeForwarder, (connection, concierge, connectionActor) -> MockClientActor.props(probe.ref()));
            watch(underTest);
    ...
    private void testForwardThingEvent(final CreateConnection createConnection, final boolean isForwarded,
        ...
        new TestKit(actorSystem) {{
            ...
            final ActorRef underTest =
                    TestConstants.createConnectionSupervisorActor(connectionId, actorSystem, pubSubMediator,
                            conciergeForwarder, (connection, conciergeForwarder, connectionActor) -> TestActor.props(probe));
            watch(underTest);
