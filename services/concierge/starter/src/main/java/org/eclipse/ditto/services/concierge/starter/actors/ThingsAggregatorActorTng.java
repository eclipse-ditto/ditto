 ...
 */
public final class ThingsAggregatorActorTng extends AbstractActor {
    ...
    private ThingsAggregatorActorTng(final ConciergeConfig.ThingsAggregatorConfig aggregatorConfig,
    ...
    public static Props props(final ConciergeConfig conciergeConfig, final ActorRef targetActor) {
        return Props.create(ThingsAggregatorActorTng.class, new Creator<ThingsAggregatorActorTng>() {
            private static final long serialVersionUID = 1L;

            @Override
            public ThingsAggregatorActorTng create() {
                return new ThingsAggregatorActorTng(conciergeConfig.getThingsAggregatorConfig(), targetActor);
            }
