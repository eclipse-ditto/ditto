 ...
 */
public abstract class AbstractEnforcerActorFactoryTng<C extends ConciergeConfig> {
    ...
    protected static ActorRef startShardRegion(final ActorSystem actorSystem,
            final ServiceSpecificConfig.ClusterConfig clusterConfig,
            final Props props) {
     ...
     */
    public abstract ActorRef startEnforcerActor(ActorContext context, C conciergeConfig,
