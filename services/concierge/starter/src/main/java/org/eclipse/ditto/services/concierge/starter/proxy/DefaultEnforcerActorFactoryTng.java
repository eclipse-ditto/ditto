...
import org.eclipse.ditto.services.concierge.starter.actors.DispatcherActorCreatorTng;
...
/**
 * Ditto default implementation of {@link org.eclipse.ditto.services.concierge.starter.proxy.AbstractEnforcerActorFactory}.
 */
public final class DefaultEnforcerActorFactoryTng extends AbstractEnforcerActorFactoryTng<ConciergeConfig> {
    ...
    public ActorRef startEnforcerActor(final ActorContext context, final ConciergeConfig conciergeConfig,
        ...
        context.actorOf(DispatcherActorCreatorTng.props(conciergeConfig, pubSubMediator, enforcerShardRegion),
