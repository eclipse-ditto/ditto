 ...
 */
package org.eclipse.ditto.services.endpoints.things;
...
import static org.eclipse.ditto.services.endpoints.base.UriEncoding.EncodingType.RFC3986;
...
import org.eclipse.ditto.services.endpoints.base.AbstractRoute;
import org.eclipse.ditto.services.endpoints.base.UriEncoding;
...
public final class ThingsRoute extends AbstractRoute {
    ...
    private static String decodePath(final String attributePointerStr) {
        ...
        return UriEncoding.decode(duplicateSlashesEliminated, RFC3986);
    }
    ...
    private static JsonObject createInlinePolicyJson(final String jsonString) {
        final JsonObject inputJson = wrapJsonRuntimeException(() -> JsonFactory.newObject(jsonString));
        return inputJson.getValue("_policy")
     ...
     * <pre>
     *    GET /things/CraasCar-1/attributes/model
     *    PUT /things/CraasCar-1/attributes/someProp
     *    DELETE /things/CraasCar-1/attributes/foo/bar
     * </pre>
     *
