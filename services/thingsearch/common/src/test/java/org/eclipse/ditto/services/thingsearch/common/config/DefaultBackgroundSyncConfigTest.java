...
/**
 * Tests {@link org.eclipse.ditto.services.thingsearch.common.config.DefaultBackgroundSyncConfig}.
 */
public final class DefaultBackgroundSyncConfigTest {
    ...
    public static void initTestFixture() {
        backgroundSyncTestConfig = ConfigFactory.load("background-sync-test");
    }
