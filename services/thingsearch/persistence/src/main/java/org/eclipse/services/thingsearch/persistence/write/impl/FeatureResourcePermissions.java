...
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_FEATURES_WITH_PATH;
...
final class FeatureResourcePermissions implements ResourcePermissions {
    ...
    static FeatureResourcePermissions getInstance(@Nonnull final Feature feature,
        ...
        final String resource = FIELD_FEATURES_WITH_PATH + feature.getId();
