 ...
 */
package org.eclipse.services.thingsearch.persistence.read.query;
...
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.CONCAT;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.COUNT_RESULT_NAME;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_ATTRIBUTES;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_ATTRIBUTES_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_DELETED;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_DELETED_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_FEATURES;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_FEATURES_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_GRANTS;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_GRANTS_VARIABLE;
...
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_INTERNAL_ACL;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_INTERNAL_FEATURE_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_INTERNAL_GLOBAL_READS;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_INTERNAL_KEY_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_INTERNAL_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_REVISION;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_REVISION_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIRST_PROJECTION;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.ID_VARIABLE;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.IF_NULL_CONDITION;
...
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.POLICY_INDEX_ID;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.PUSH_PROJECTION;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.SUM_GROUPING;
...
import org.eclipse.services.thingsearch.persistence.BsonUtil;
import org.eclipse.services.thingsearch.persistence.read.criteria.visitors.CreateBsonVisitor;
import org.eclipse.services.thingsearch.persistence.read.criteria.visitors.CreatePolicyRestrictionBsonVisitor;
import org.eclipse.services.thingsearch.persistence.read.criteria.visitors.CreateUnwoundBsonVisitor;
import org.eclipse.services.thingsearch.persistence.read.expression.visitors.GetSortBsonVisitor;
import org.eclipse.services.thingsearch.querymodel.criteria.AnyCriteriaImpl;
...
import org.eclipse.services.thingsearch.querymodel.criteria.Predicate;
import org.eclipse.services.thingsearch.querymodel.expression.FilterFieldExpression;
import org.eclipse.services.thingsearch.querymodel.expression.SimpleFieldExpressionImpl;
import org.eclipse.services.thingsearch.querymodel.expression.SortFieldExpression;
...
import org.eclipse.services.thingsearch.querymodel.query.QueryConstants;
import org.eclipse.services.thingsearch.querymodel.query.SortDirection;
import org.eclipse.services.thingsearch.querymodel.query.SortOption;
