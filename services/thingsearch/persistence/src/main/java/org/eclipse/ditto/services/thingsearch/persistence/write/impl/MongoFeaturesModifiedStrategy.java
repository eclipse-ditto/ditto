...
/**
 * Strategy that allows create {@link Bson} for {@link FeaturesModified} events.
 */
public final class MongoFeaturesModifiedStrategy extends MongoEventToPersistenceStrategy<FeaturesModified> {
     ...
     */
    @Override
    public final List<Bson> thingUpdates(final ProcessableThingEvent<FeaturesModified> event,
     ...
     */
    @Override
    public final List<PolicyUpdate> policyUpdates(final ProcessableThingEvent<FeaturesModified> event,
