...
import org.eclipse.services.thingsearch.persistence.read.expression.visitors.IsInternalViewVisitor;
...
public class ContainsAllRequiredResourcesVisitor implements CriteriaVisitor<Predicate<Document>> {
    ...
    public Predicate<Document> visitField(final FilterFieldExpression fieldExpression,
            final org.eclipse.services.thingsearch.querymodel.criteria.Predicate predicate) {
        return thingResult -> {
