...
import org.eclipse.services.thingsearch.persistence.IndexInitializer;
...
import org.eclipse.services.thingsearch.persistence.read.query.MongoQuery;
...
public class MongoThingsSearchPersistence implements ThingsSearchPersistence {
    ...
    public Source<Long, NotUsed> count(final PolicyRestrictedSearchAggregation policyRestrictedSearchAggregation) {
        ...
        return source.map(doc -> doc.get(COUNT_RESULT_NAME))
