...
import static org.eclipse.services.thingsearch.persistence.MongoSortKeyMappingFunction.mapSortKey;
...
import org.eclipse.services.thingsearch.querymodel.expression.visitors.SortFieldExpressionVisitor;
...
public final class GetSortBsonVisitor implements SortFieldExpressionVisitor<List<Bson>> {
    ...
    public List<Bson> visitAttribute(final String key) {
        final String sortKey = mapSortKey(PersistenceConstants.FIELD_ATTRIBUTES, key);
    ...
    public List<Bson> visitFeatureIdProperty(final String featureId, final String property) {
        final String sortKey =
                mapSortKey(PersistenceConstants.FIELD_FEATURES, featureId, PersistenceConstants.FIELD_PROPERTIES,
                        property);
        return getSortBson(sortDirection, sortKey);
    }
