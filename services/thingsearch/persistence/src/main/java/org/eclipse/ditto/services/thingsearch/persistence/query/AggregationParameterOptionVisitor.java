...
public final class AggregationParameterOptionVisitor implements OptionVisitor {
     ...
     */
    public AggregationParameterOptionVisitor(final FieldExpressionFactory fieldExpressionFactory,
