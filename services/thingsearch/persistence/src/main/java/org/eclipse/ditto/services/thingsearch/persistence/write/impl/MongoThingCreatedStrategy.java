...
/**
 * Strategy that allows create {@link Bson} for {@link ThingCreated} events.
 */
public final class MongoThingCreatedStrategy extends MongoEventToPersistenceStrategy<ThingCreated> {

    /**
     * {@inheritDoc}
     */
    @Override
    public final List<Bson> thingUpdates(final ProcessableThingEvent<ThingCreated> event,
     ...
     */
    @Override
    public final List<PolicyUpdate> policyUpdates(final ProcessableThingEvent<ThingCreated> event,
