 ...
 */
package org.eclipse.services.thingsearch.persistence.read.criteria.visitors;

import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_GRANTS_GRANTED;
import static org.eclipse.services.thingsearch.persistence.PersistenceConstants.FIELD_GRANTS_REVOKED;
...
import org.eclipse.services.thingsearch.persistence.read.expression.visitors.GetPolicyRestrictionBsonVisitor;
import org.eclipse.services.thingsearch.persistence.read.expression.visitors.GetUnwoundExistsFilterBsonVisitor;
...
import org.eclipse.services.thingsearch.querymodel.criteria.visitors.CriteriaVisitor;
import org.eclipse.services.thingsearch.querymodel.expression.ExistsFieldExpression;
import org.eclipse.services.thingsearch.querymodel.expression.FieldExpression;
...
public class CreatePolicyRestrictionBsonVisitor implements CriteriaVisitor<Optional<Bson>> {
    ...
    private CreatePolicyRestrictionBsonVisitor(final Predicate authorizationSubjectsPredicate) {
        grantedBson = CreateBsonPredicateVisitor.apply(authorizationSubjectsPredicate, FIELD_GRANTS_GRANTED);
        notRevokedBson =
                Filters.not(CreateBsonPredicateVisitor.apply(authorizationSubjectsPredicate, FIELD_GRANTS_REVOKED));
    }
