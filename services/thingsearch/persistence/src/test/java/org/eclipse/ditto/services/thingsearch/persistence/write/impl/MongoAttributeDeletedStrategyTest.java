...
public final class MongoAttributeDeletedStrategyTest extends AbstractMongoEventToPersistenceStrategyTest {

    private final MongoAttributeDeletedStrategy strategy = new MongoAttributeDeletedStrategy();
    ...
    private ProcessableThingEvent<AttributeDeleted> thingEvent() {
        return ProcessableThingEvent.newInstance(TestConstants.ThingEvent.ATTRIBUTE_DELETED, version);
    }
