...
public final class MongoFeaturePropertiesDeletedStrategyTest extends AbstractMongoEventToPersistenceStrategyTest {
    ...
    private ProcessableThingEvent<FeaturePropertiesDeleted> thingEvent() {
        return ProcessableThingEvent.newInstance(TestConstants.ThingEvent.FEATURE_PROPERTIES_DELETED, version);
    }
