...
public final class MongoFeatureDeletedStrategyTest extends AbstractMongoEventToPersistenceStrategyTest {

    private final MongoFeatureDeletedStrategy strategy = new MongoFeatureDeletedStrategy();
    ...
    private ProcessableThingEvent<FeatureDeleted> thingEvent() {
        return ProcessableThingEvent.newInstance(TestConstants.ThingEvent.FEATURE_DELETED, version);
    }
