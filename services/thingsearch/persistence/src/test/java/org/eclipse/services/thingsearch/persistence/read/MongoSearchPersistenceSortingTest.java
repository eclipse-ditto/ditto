...
import org.eclipse.services.thingsearch.common.model.ResultListImpl;
...
import org.eclipse.services.thingsearch.querymodel.expression.AttributeExpressionImpl;
import org.eclipse.services.thingsearch.querymodel.expression.FeatureIdPropertyExpressionImpl;
...
public final class MongoSearchPersistenceSortingTest extends AbstractReadPersistenceTestBase {
    ...
    private void runInternally(final SortFieldExpression sortField,
        ...
        final Query query = qbf.newBuilder(cf.any()).sort(sortOptions).build();
