...
public final class MongoFeaturePropertiesModifiedStrategyTest extends AbstractMongoEventToPersistenceStrategyTest {
    ...
    private final MongoFeaturePropertiesModifiedStrategy strategy = new MongoFeaturePropertiesModifiedStrategy();
    ...
    private FeaturePropertiesModified thingEvent() {
        return setVersion(TestConstants.ThingEvent.FEATURE_PROPERTIES_MODIFIED);
    }
