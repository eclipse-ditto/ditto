...
public final class MongoFeaturePropertyCreatedStrategyTest extends AbstractMongoEventToPersistenceStrategyTest {
    ...
    private ProcessableThingEvent<FeaturePropertyCreated> thingEvent() {
        return ProcessableThingEvent.newInstance(TestConstants.ThingEvent.FEATURE_PROPERTY_CREATED, version);
    }
