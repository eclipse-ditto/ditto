        ...
        new TestKit(actorSystem) {
            {
                ...
                changeQueueTestProbe.expectMsg(Metadata.of(THING_ID, 1L, null, -1L, null));
            }
        };
    }
        ...
        new TestKit(actorSystem) {
            {
                ...
                changeQueueTestProbe.expectMsg(Metadata.of(THING_ID, revision, null, -1L, null));

                underTest.tell(thingTag, ActorRef.noSender());
                changeQueueTestProbe.expectMsg(Metadata.of(THING_ID, thingTagRevision, null, -1L, null));
            }
        };
    }
