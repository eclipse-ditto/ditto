 ...
 */
package org.eclipse.services.thingsearch.query.actors;
...
import org.eclipse.services.thingsearch.query.AnswerWithSelf;
import org.eclipse.services.thingsearch.querymodel.expression.FieldExpressionFactory;
import org.eclipse.services.thingsearch.querymodel.expression.FieldExpressionUtil;
import org.eclipse.services.thingsearch.querymodel.expression.SortFieldExpression;
import org.eclipse.services.thingsearch.querymodel.query.QueryBuilder;
...
public final class ParameterOptionVisitorTest {
    ...
    public void visitSortOptionOwner() {
        ...
        verify(qbMock).sort(
                Collections.singletonList(new org.eclipse.services.thingsearch.querymodel.query.SortOption(exprMock,
                        SortDirection.ASC)));
    }
    ...
    public void visitSortOptionThingId() {
        ...
        verify(qbMock).sort(
                Collections.singletonList(
                        new org.eclipse.services.thingsearch.querymodel.query.SortOption(exprMock, SortDirection
                                .ASC)));
    }
    ...
    public void visitSortOptionMultiple() {
        ...
        verify(exprFactoryMock).sortBy(FieldExpressionUtil.FIELD_NAME_OWNER);
        verify(qbMock).sort(
                Arrays.asList(new org.eclipse.services.thingsearch.querymodel.query.SortOption(exprMock,
                                SortDirection.DESC),
                        new org.eclipse.services.thingsearch.querymodel.query.SortOption(exprMock,
                                SortDirection.ASC)));
    }
