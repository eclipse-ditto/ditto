 ...
 */
final class ThingUpdaterOld extends AbstractActorWithStashWithTimers {
    ...
    private ThingUpdaterOld(final ActorRef pubSubMediator,
    ...
    ThingUpdaterOld(final ActorRef pubSubMediator,
            final ActorRef changeQueueActor,
            final double forceUpdateProbability,
            final Duration forceUpdateAfterStartTimeout,
            final double forceUpdateAfterStartRandomFactor,
    ...
    static Props props(final ActorRef pubSubMediator, final ActorRef changeQueueActor,
        ...
        return Props.create(ThingUpdaterOld.class, pubSubMediator, changeQueueActor,
