...
/**
 * Unit test for {@link ThingMigrateCommandAdapter}.
 */
public final class ThingMigrateCommandAdapterTest extends LiveTwinTest implements ProtocolAdapterTest {

    private ThingMigrateCommandAdapter underTest;

    private TopicPath topicPath;

    @Before
    public void setUp() {
        underTest = ThingMigrateCommandAdapter.of(DittoProtocolAdapter.getHeaderTranslator());
