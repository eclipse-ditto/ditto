...
public class ThingMigrateCommandResponseAdapterTest extends LiveTwinTest implements ProtocolAdapterTest {

    private ThingMigrateCommandResponseAdapter underTest;
    ...
    @Before
    public void setUp() {
        underTest = ThingMigrateCommandResponseAdapter.of(DittoProtocolAdapter.getHeaderTranslator());
    }
    @Test
