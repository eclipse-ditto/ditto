...
/**
 * An {@code Adapter} maps objects of type {@link ThingMigrated} to an {@link org.eclipse.ditto.protocol.Adaptable} and
 * vice versa.
 *
 * @since 3.7.0
 */
public interface MigratedEventAdapter extends Adapter<ThingMigrated> {
