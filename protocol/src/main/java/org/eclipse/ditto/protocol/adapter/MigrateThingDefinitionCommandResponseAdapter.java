...
/**
 * An {@code Adapter} mixin for migrate thing definition command responses.
 *
 * @since 3.7.0
 */
public interface MigrateThingDefinitionCommandResponseAdapter extends Adapter<MigrateThingDefinitionResponse> {
