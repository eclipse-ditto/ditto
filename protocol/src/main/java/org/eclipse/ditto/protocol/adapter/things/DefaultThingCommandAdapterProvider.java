...
public class DefaultThingCommandAdapterProvider implements ThingCommandAdapterProvider {
    ...
    private final ThingDefinitionMigrateCommandResponseAdapter thingDefinitionMigrateCommandResponseAdapter;
    private final ThingDefinitionMigrateCommandAdapter thingDefinitionMigrateCommandAdapter;
    ...
    private final ThingDefinitionMigratedEventAdapter thingDefinitionMigratedEventAdapter;
    ...
    public DefaultThingCommandAdapterProvider(final ErrorRegistry<DittoRuntimeException> errorRegistry,
        ...
        this.thingDefinitionMigrateCommandAdapter = ThingDefinitionMigrateCommandAdapter.of(headerTranslator);
        ...
        this.thingDefinitionMigratedEventAdapter = ThingDefinitionMigratedEventAdapter.of(headerTranslator);
        this.thingDefinitionMigrateCommandResponseAdapter = ThingDefinitionMigrateCommandResponseAdapter.of(headerTranslator);
    ...
    public List<Adapter<?>> getAdapters() {
        return Arrays.asList(
                ...
                thingDefinitionMigrateCommandAdapter,
                messageCommandAdapter,
                messageCommandResponseAdapter,
                thingEventAdapter,
                thingMergedEventAdapter,
                thingDefinitionMigratedEventAdapter,
                thingDefinitionMigrateCommandResponseAdapter,
    ...
    public Adapter<ThingDefinitionMigrated> getThingDefinitionMigratedEventAdapter() {
        return thingDefinitionMigratedEventAdapter;
    }

    @Override
    public Adapter<MigrateThingDefinitionResponse> getMigrateThingDefinitionCommandResponseAdapter() {
        return thingDefinitionMigrateCommandResponseAdapter;
    }
    ...
    @Override
    public Adapter<MigrateThingDefinition> getMigrateThingDefinitionCommandAdapter() {
        return thingDefinitionMigrateCommandAdapter;
    }
